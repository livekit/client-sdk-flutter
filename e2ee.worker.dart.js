        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              A._asJSObject(t2.self).onmessage = A._functionToJS1(new A.main_closure1(new A.main_handleMessage()));
              // implicit return
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 2:
              ...
              t6 = $.$get$logger();
              t6.log$4(B.Level_FINER_400, string$.decode + A.NativeUint8List_NativeUint8List$view(decrypted, 0, null).length, null, null);
              t3 = t5.decrypted;
              if (t3 == null)
                throw A.wrapException(A.Exception_Exception("[decryptFrameInternal] could not decrypt"));
              t6.log$4(B.Level_FINER_400, string$.decode + A.NativeUint8List_NativeUint8List$view(t3, 0, null).length, null, null);
              $async$goto = t9.currentkeySet !== t5.initialKeySet ? 3 : 4;
              break;
            case 3:
              // then
              t6.log$4(B.Level_FINE_500, "decodeFunction::decryptFrameInternal: ratchetKey: decryption ok, newState: kKeyRatcheted", null, null);
              $async$goto = 5;
