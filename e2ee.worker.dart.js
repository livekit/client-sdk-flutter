...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    KeyOptions: function KeyOptions(t0, t1, t2, t3, t4) {
      var _ = this;
      _.sharedKey = t0;
      _.ratchetSalt = t1;
          ...
          switch ($async$goto) {
            case 0:
              ...
              if (self.self.RTCTransformEvent != null) {
                ...
                self.self.onrtctransform = A.allowInterop(new A.main_closure0(), type$.dynamic_Function_dynamic);
              }
              A._EventStreamSubscription$(type$.nullable_EventTarget._as(self.self), "message", type$.nullable_void_Function_MessageEvent._as(new A.main_closure1()), false, type$.MessageEvent);
              // implicit return
  ...
  A.FormatException.prototype = {
    toString$0(_) {
      var lineEnd, lineNum, lineStart, previousCharWasCR, i, char, end, start, prefix, postfix,
  ...
  A.FrameCryptor.prototype = {
    ...
    setupTransform$body$FrameCryptor(codec, kind, operation, readable, trackId, writable) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$self = this, transformer, e, t2, t3, exception, t1;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = $.$get$logger();
              t1.log$4(B.Level_INFO_800, "setupTransform " + operation, null, null);
              ...
              try {
                ...
                if ($async$self.lastError !== B.CryptorError_7) {
                  ...
                  B.DedicatedWorkerGlobalScope_methods.postMessage$1($async$self.worker, A.LinkedHashMap_LinkedHashMap$_literal(["type", "cryptorState", "msgType", "event", "participantId", $async$self.participantIdentity, "state", "internalError", "error", "Internal error: " + J.toString$0$(e)], t3, type$.nullable_String));
                }
              }
    ...
    getUnencryptedBytes$2(frame, codec) {
      var data, naluIndices, t1, t2, _i, index, type, _null = null;
      if (codec != null && codec.toLowerCase() === "h264") {
        data = A.NativeUint8List_NativeUint8List$view(J.get$data$x(frame), 0, _null);
    ...
    encodeFunction$body$FrameCryptor(frame, controller) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, $async$handler = 2, $async$currentError, $async$self = this, secretKey, keyIndex, headerLength, metaData, iv, frameTrailer, cipherText, finalBuffer, e, t2, keyIndex0, t3, t4, iv0, sendCount, exception, t1, buffer, $async$exception;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              if (!$async$self.get$enabled(0) || J.get$length$asx(buffer) === 0) {
              ...
              keyIndex0 = $async$self.currentKeyIndex;
              keyIndex = keyIndex0;
              if (secretKey == null) {
                if ($async$self.lastError !== B.CryptorError_5) {
                  ...
                  B.DedicatedWorkerGlobalScope_methods.postMessage$1($async$self.worker, A.LinkedHashMap_LinkedHashMap$_literal(["type", "cryptorState", "msgType", "event", "participantId", t1, "trackId", t2, "kind", t3, "state", "missingKey", "error", "Missing key for track " + t2, "currentKeyIndex", keyIndex0, "secretKey", J.toString$0$(secretKey)], type$.String, type$.nullable_Object));
                }
                // goto return
                $async$goto = 1;
                break;
            ...
            case 7:
              ...
              t2 = $.$get$logger();
              t2.log$4(B.Level_FINER_400, "buffer: " + J.get$length$asx(buffer) + ", cipherText: " + A.NativeUint8List_NativeUint8List$view(cipherText, 0, null).length, null, null);
              ...
              if ($async$self.lastError !== B.CryptorError_1) {
                ...
                B.DedicatedWorkerGlobalScope_methods.postMessage$1($async$self.worker, A.LinkedHashMap_LinkedHashMap$_literal(["type", "cryptorState", "msgType", "event", "participantId", $async$self.participantIdentity, "trackId", $async$self.trackId, "kind", $async$self.__FrameCryptor_kind_A, "state", "ok", "error", "encryption ok", "frameTrailer", A.NativeUint8List_NativeUint8List$view(frameTrailer.buffer, 0, null), "currentKeyIndex", $async$self.currentKeyIndex, "secretKey", "Instance of '" + A.Primitives_objectTypeName(secretKey) + "'"], type$.String, type$.nullable_Object));
              }
              t2.log$4(B.Level_FINER_400, "encrypto kind " + $async$self.__FrameCryptor_kind_A + ",codec " + A.S($async$self.codec) + " headerLength: " + A.S(headerLength) + ",  timestamp: " + A.S(t1.get$timestamp(frame)) + ", ssrc: " + A.S(J.get$synchronizationSource$x(metaData)) + ", data length: " + J.get$length$asx(buffer) + ", encrypted length: " + finalBuffer.toBytes$0().length + ", iv " + A.S(iv), null, null);
              $async$handler = 2;
              // goto after finally
              $async$goto = 6;
              break;
            case 4:
              ...
              $.$get$logger().log$4(B.Level_WARNING_900, "encrypt: e " + J.toString$0$(e), null, null);
              if ($async$self.lastError !== B.CryptorError_3) {
                ...
                t3 = $async$self.__FrameCryptor_kind_A;
                t3 === $ && A.throwLateFieldNI("kind");
                B.DedicatedWorkerGlobalScope_methods.postMessage$1($async$self.worker, A.LinkedHashMap_LinkedHashMap$_literal(["type", "cryptorState", "msgType", "event", "participantId", t1, "trackId", t2, "kind", t3, "state", "encryptError", "error", J.toString$0$(e)], type$.String, type$.nullable_String));
              }
              // goto after finally
              $async$goto = 6;
              break;
    ...
    decodeFunction$body$FrameCryptor(frame, controller) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, $async$handler = 2, $async$currentError, $async$self = this, headerLength, metaData, frameTrailer, ivLength, keyIndex, iv, endDecLoop, currentkeySet, newKeyBuffer, newMaterial, finalBuffer, e, t2, t3, t4, t5, magicBytesBuffer, t6, t7, t8, t9, t10, t11, exception, ratchetCount, t1, buffer, decrypted, initialKeySet, initialKeyIndex, $async$exception, $async$exception1, $async$temp1;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t2 = $async$self.keyHandler.keyOptions.uncryptedMagicBytes;
              if (t2 != null) {
                t3 = J.get$length$asx(buffer);
                t4 = t2.length;
                t5 = t4 + 1;
                if (t3 > t5) {
                  magicBytesBuffer = J.sublist$2$x(buffer, J.get$length$asx(buffer) - t4 - 1, J.get$length$asx(buffer) - 1);
                  t3 = $.$get$logger();
                  t3.log$4(B.Level_FINER_400, "magicBytesBuffer " + A.S(magicBytesBuffer) + ", magicBytes " + A.S(t2) + ", ", null, null);
                  t4 = $async$self.sifGuard;
                  if (A.Iterable_iterableToFullString(magicBytesBuffer, "[", "]") === A.Iterable_iterableToFullString(t2, "[", "]")) {
                    ...
                    if (t2) {
                      ...
                      t3.log$4(B.Level_FINER_400, "skip uncrypted frame, type " + t2[0], null, null);
                      finalBuffer = new A._CopyingBytesBuilder($.$get$_CopyingBytesBuilder__emptyList());
                      finalBuffer.add$1(0, new Uint8Array(A._ensureNativeList(J.sublist$2$x(buffer, 0, J.get$length$asx(buffer) - t5))));
                      t1.set$data(frame, A.jsArrayBufferFrom(finalBuffer.toBytes$0()));
                      J.enqueue$1$x(controller, frame);
                    } else
                      t3.log$4(B.Level_FINER_400, "SIF limit reached, dropping frame", null, null);
                    // goto return
                    $async$goto = 1;
                    break;
                  } else
              ...
              initialKeySet = $async$self.keyHandler.getKeySet$1(keyIndex);
              ...
              if (initialKeySet == null || !$async$self.keyHandler._hasValidKey) {
                if ($async$self.lastError !== B.CryptorError_5) {
                  ...
                  t2 = $async$self.trackId;
                  t3 = $async$self.__FrameCryptor_kind_A;
                  t4 = A.NativeUint8List_NativeUint8List$view(frameTrailer.buffer, 0, null);
                  t5 = initialKeySet;
                  t5 = t5 == null ? null : "Instance of '" + A.Primitives_objectTypeName(t5.encryptionKey) + "'";
                  B.DedicatedWorkerGlobalScope_methods.postMessage$1($async$self.worker, A.LinkedHashMap_LinkedHashMap$_literal(["type", "cryptorState", "msgType", "event", "participantId", t1, "trackId", t2, "kind", t3, "state", "missingKey", "error", "Missing key for track " + t2, "frameTrailer", t4, "currentKeyIndex", keyIndex, "secretKey", t5], type$.String, type$.nullable_Object));
                }
                J.enqueue$1$x(controller, frame);
                // goto return
                $async$goto = 1;
              ...
              endDecLoop = false;
              currentkeySet = initialKeySet;
              t2 = type$.ByteBuffer, t3 = type$.String, t4 = type$.nullable_Object, t5 = $async$self.worker;
            case 7:
              // for condition
              ...
              $async$handler = 10;
              t6 = buffer;
              t6 = {name: "AES-GCM", iv: A.jsArrayBufferFrom(iv), additionalData: A.jsArrayBufferFrom(new Uint8Array(t6.subarray(0, A._checkValidRange(0, A._asIntQ(headerLength), J.get$length$asx(t6)))))};
              t7 = currentkeySet.encryptionKey;
              t8 = buffer;
              t9 = J.get$length$asx(buffer);
              t10 = ivLength;
              if (typeof t10 !== "number") {
                $async$returnValue = A.iae(t10);
                // goto return
                $async$goto = 1;
                break;
              }
              t11 = A._asInt(headerLength);
              $async$goto = 13;
              return A._asyncAwait(A.promiseToFuture(self.crypto.subtle.decrypt(t6, t7, A.jsArrayBufferFrom(new Uint8Array(t8.subarray(t11, A._checkValidRange(t11, A._asIntQ(t9 - t10 - 2), J.get$length$asx(t8)))))), t2), $async$decodeFunction$2);
            case 13:
              // returning from await.
              decrypted = $async$result;
              $async$goto = !J.$eq$(currentkeySet, initialKeySet) ? 14 : 15;
              break;
            case 14:
              // then
              $.$get$logger().log$4(B.Level_WARNING_900, "ratchetKey: decryption ok, reset state to kKeyRatcheted", null, null);
              $async$goto = 16;
              return A._asyncAwait($async$self.keyHandler.setKeySetFromMaterial$2(currentkeySet, initialKeyIndex), $async$decodeFunction$2);
            case 16:
              // returning from await.
            case 15:
              // join
              endDecLoop = true;
              t6 = $async$self.lastError;
              if (t6 !== B.CryptorError_1)
                if (t6 !== B.CryptorError_6) {
                  t6 = ratchetCount;
                  if (typeof t6 !== "number") {
                    $async$returnValue = t6.$gt();
                    // goto return
                    $async$goto = 1;
                    break;
                  }
              ...
              if (t6) {
                t6 = $.$get$logger();
                t6.log$4(B.Level_FINER_400, "KeyRatcheted: ssrc " + A.S(J.get$synchronizationSource$x(metaData)) + " timestamp " + A.S(t1.get$timestamp(frame)) + " ratchetCount " + A.S(ratchetCount) + "  participantId: " + A.S($async$self.participantIdentity), null, null);
                t6.log$4(B.Level_FINER_400, "ratchetKey: lastError != CryptorError.kKeyRatcheted, reset state to kKeyRatcheted", null, null);
                $async$self.lastError = B.CryptorError_6;
                t6 = $async$self.participantIdentity;
                t7 = $async$self.trackId;
                t8 = $async$self.__FrameCryptor_kind_A;
                t9 = frameTrailer.buffer;
                t9 = new Uint8Array(t9, 0);
                B.DedicatedWorkerGlobalScope_methods.postMessage$1(t5, A.LinkedHashMap_LinkedHashMap$_literal(["type", "cryptorState", "msgType", "event", "participantId", t6, "trackId", t7, "kind", t8, "state", "keyRatcheted", "error", "Key ratcheted ok", "frameTrailer", t9, "currentKeyIndex", $async$self.currentKeyIndex, "secretKey", "Instance of '" + A.Primitives_objectTypeName(currentkeySet.encryptionKey) + "'"], t3, t4));
              }
              $async$handler = 4;
              // goto after finally
              $async$goto = 12;
            ...
            case 10:
              ...
              $async$self.lastError = B.CryptorError_7;
              t6 = ratchetCount;
              t7 = $async$self.keyHandler;
              t8 = t7.keyOptions;
              t9 = t8.ratchetWindowSize;
              if (typeof t6 !== "number") {
              ...
              endDecLoop = t6 >= t9 || t9 <= 0;
              if (A.boolConversionCheck(endDecLoop))
                throw $async$exception;
              $async$temp1 = A;
              $async$goto = 17;
              return A._asyncAwait(t7.ratchet$2(currentkeySet.material, t8.ratchetSalt), $async$decodeFunction$2);
            case 17:
              // returning from await.
              newKeyBuffer = $async$temp1.jsArrayBufferFrom($async$result);
              $async$goto = 18;
              return A._asyncAwait($async$self.keyHandler.ratchetMaterial$2(currentkeySet.material, newKeyBuffer), $async$decodeFunction$2);
            case 18:
              // returning from await.
              newMaterial = $async$result;
              t6 = $async$self.keyHandler;
              $async$goto = 19;
              return A._asyncAwait(t6.deriveKeys$2(newMaterial, t6.keyOptions.ratchetSalt), $async$decodeFunction$2);
            case 19:
              // returning from await.
            ...
            case 8:
              // after for
              t2 = $.$get$logger();
              t6 = J.get$length$asx(buffer);
              t7 = decrypted;
              t7 = t7 == null ? null : A.NativeUint8List_NativeUint8List$view(t7, 0, null).length;
              if (t7 == null)
                t7 = 0;
              t2.log$4(B.Level_FINER_400, "buffer: " + t6 + ", decrypted: " + t7, null, null);
              t6 = $.$get$_CopyingBytesBuilder__emptyList();
              finalBuffer = new A._CopyingBytesBuilder(t6);
              J.add$1$ax(finalBuffer, new Uint8Array(A._ensureNativeList(J.sublist$2$x(buffer, 0, headerLength))));
              t6 = decrypted;
              t6.toString;
              J.add$1$ax(finalBuffer, A.NativeUint8List_NativeUint8List$view(t6, 0, null));
              t1.set$data(frame, A.jsArrayBufferFrom(finalBuffer.toBytes$0()));
              J.enqueue$1$x(controller, frame);
              if ($async$self.lastError !== B.CryptorError_1) {
                $async$self.lastError = B.CryptorError_1;
                B.DedicatedWorkerGlobalScope_methods.postMessage$1(t5, A.LinkedHashMap_LinkedHashMap$_literal(["type", "cryptorState", "msgType", "event", "participantId", $async$self.participantIdentity, "trackId", $async$self.trackId, "kind", $async$self.__FrameCryptor_kind_A, "state", "ok", "error", "decryption ok", "frameTrailer", A.NativeUint8List_NativeUint8List$view(frameTrailer.buffer, 0, null), "currentKeyIndex", $async$self.currentKeyIndex, "secretKey", "Instance of '" + A.Primitives_objectTypeName(currentkeySet.encryptionKey) + "'"], t3, t4));
              }
              t2.log$4(B.Level_FINER_400, "decrypto kind " + $async$self.__FrameCryptor_kind_A + ",codec " + A.S($async$self.codec) + " headerLength: " + A.S(headerLength) + ", timestamp: " + A.S(t1.get$timestamp(frame)) + ", ssrc: " + A.S(J.get$synchronizationSource$x(metaData)) + ", data length: " + J.get$length$asx(buffer) + ", decrypted length: " + finalBuffer.toBytes$0().length + ", keyindex " + A.S(keyIndex) + " iv " + A.S(iv), null, null);
              $async$handler = 2;
              // goto after finally
              $async$goto = 6;
              break;
            case 4:
              ...
              if ($async$self.lastError !== B.CryptorError_2) {
                ...
                t3 = $async$self.__FrameCryptor_kind_A;
                t3 === $ && A.throwLateFieldNI("kind");
                B.DedicatedWorkerGlobalScope_methods.postMessage$1($async$self.worker, A.LinkedHashMap_LinkedHashMap$_literal(["type", "cryptorState", "msgType", "event", "participantId", t1, "trackId", t2, "kind", t3, "state", "decryptError", "error", J.toString$0$(e)], type$.String, type$.nullable_String));
              }
              $async$goto = initialKeySet != null ? 20 : 21;
              break;
            case 20:
              // then
              $.$get$logger().log$4(B.Level_WARNING_900, "decryption failed, ratcheting back to initial key, keyIndex: " + A.S(initialKeyIndex), null, null);
              $async$goto = 22;
              return A._asyncAwait($async$self.keyHandler.setKeySetFromMaterial$2(initialKeySet, initialKeyIndex), $async$decodeFunction$2);
            case 22:
              // returning from await.
            case 21:
              // join
  ...
  A.KeyProvider.prototype = {
    getParticipantKeyHandler$1(participantIdentity) {
      ...
      if (keys == null) {
        keys = new A.ParticipantKeyHandler(A.List_List$filled(16, null, false, type$.nullable_KeySet), t1, participantIdentity);
        t1 = _this.sharedKey;
        if (t1.length !== 0)
          keys.setKey$1(t1);
    ...
    getSharedKeyHandler$0() {
      var t1 = this.sharedKeyHandler;
      return t1 == null ? this.sharedKeyHandler = new A.ParticipantKeyHandler(A.List_List$filled(16, null, false, type$.nullable_KeySet), this.keyProviderOptions, "shared-key") : t1;
    }
  };
  A.KeySet.prototype = {};
  A.ParticipantKeyHandler.prototype = {
    ...
    exportKey$1(keyIndex) {
      var $async$goto = 0,
        ...
        $async$returnValue, $async$handler = 2, $async$currentError, $async$self = this, key, e, exception, t1, currentMaterial, $async$exception;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$handler = 4;
              $async$goto = 7;
              return A._asyncAwait(A.promiseToFuture(self.crypto.subtle.exportKey("raw", currentMaterial), type$.ByteBuffer), $async$exportKey$1);
            case 7:
              // returning from await.
              key = $async$result;
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 3:
              ...
              newKey = $async$result;
              $async$goto = 5;
              return A._asyncAwait($async$self.ratchetMaterial$2(currentMaterial, A.jsArrayBufferFrom(newKey)), $async$ratchetKey$1);
            case 5:
              // returning from await.
              $async$goto = 4;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$goto = 3;
              return A._asyncAwait(A.promiseToFuture(self.crypto.subtle.importKey("raw", newKeyBuffer, J.get$name$x(type$.Algorithm._as(currentMaterial.algorithm)), false, A._setArrayType(["deriveBits", "deriveKey"], type$.JSArray_String)), type$.dynamic), $async$ratchetMaterial$2);
            case 3:
              // returning from await.
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 4;
              return A._asyncAwait(A.impportKeyFromRawData(key, A._setArrayType(["deriveBits", "deriveKey"], type$.JSArray_String), "PBKDF2"), $async$setKey$2$keyIndex);
            case 4:
              // returning from await.
              $async$goto = 3;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = $.$get$logger();
              t1.log$4(B.Level_CONFIG_700, "setKeySetFromMaterial: set new key, index: " + keyIndex, null, null);
              if (keyIndex >= 0)
              ...
              t1.log$4(B.Level_CONFIG_700, "setKeySetFromMaterial: currentIndex: " + $async$self.currentKeyIndex, null, null);
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
  ...
  A.main_closure0.prototype = {
    call$1($event) {
      var t2, options, t3, t4, kind, participantId, trackId, codec, msgType, keyProviderId, keyProvider, cryptor, _null = null,
        t1 = $.$get$logger();
      t1.log$4(B.Level_INFO_800, "Got onrtctransform event", _null, _null);
      t2 = type$.JavaScriptObject._as(type$.RTCTransformEvent._as($event).transformer);
      t2.handled = true;
      options = t2.options;
      t3 = options == null;
      t4 = t3 ? type$.Object._as(options) : options;
      kind = t4.kind;
      t4 = t3 ? type$.Object._as(options) : options;
      participantId = t4.participantId;
      t4 = t3 ? type$.Object._as(options) : options;
      trackId = t4.trackId;
      t4 = t3 ? type$.Object._as(options) : options;
      codec = t4.codec;
      t4 = t3 ? type$.Object._as(options) : options;
      msgType = t4.msgType;
      t3 = t3 ? type$.Object._as(options) : options;
      keyProviderId = t3.keyProviderId;
      keyProvider = $.keyProviders.$index(0, keyProviderId);
      if (keyProvider == null) {
        t1.log$4(B.Level_WARNING_900, "KeyProvider not found for " + A.S(keyProviderId), _null, _null);
        return;
      }
      A._asString(participantId);
      A._asString(trackId);
      cryptor = A.getTrackCryptor(participantId, trackId, keyProvider);
      A._asString(msgType);
      t1 = type$.ReadableStream._as(t2.readable);
      t2 = type$.WritableStream._as(t2.writable);
      A._asString(kind);
      cryptor.setupTransform$6$codec$kind$operation$readable$trackId$writable(A._asStringQ(codec), kind, msgType, t1, trackId, t2);
    },
    $signature: 3
  };
  A.main_closure1.prototype = {
    ...
    $call$body$main_closure(e) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, copy, msgType, msgId, options, keyProviderId, t3, t4, t5, t6, keyProviderOptions, enabled, trackId, cryptors, _i, cryptor, kind, exist, participantId, readable, writable, keyProvider, key, keyIndex, newKey, c, sifTrailer, codec, t1, t2;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              msgId = A._asStringQ(t1.$index(copy, "msgId"));
              t2 = $.$get$logger();
              t2.log$4(B.Level_INFO_800, "Got message " + A.S(msgType) + ", msgId " + A.S(msgId), null, null);
            case 3:
              // switch
              switch (msgType) {
            ...
            case 5:
              ...
              keyProviderId = A._asString(t1.$index(copy, "keyProviderId"));
              t1 = J.getInterceptor$asx(options);
              t3 = A._asBool(t1.$index(options, "sharedKey"));
              t4 = new Uint8Array(A._ensureNativeList(B.C_Base64Decoder.convert$1(A._asString(t1.$index(options, "ratchetSalt")))));
              t5 = A._asInt(t1.$index(options, "ratchetWindowSize"));
              t6 = t1.$index(options, "failureTolerance");
              t6 = A._asInt(t6 == null ? -1 : t6);
              keyProviderOptions = new A.KeyOptions(t3, t4, t5, t6, t1.$index(options, "uncryptedMagicBytes") != null ? new Uint8Array(A._ensureNativeList(B.C_Base64Decoder.convert$1(A._asString(t1.$index(options, "uncryptedMagicBytes"))))) : null);
              t2.log$4(B.Level_CONFIG_700, "Init with keyProviderOptions:\n " + keyProviderOptions.toString$0(0), null, null);
              t1 = self.self;
              t2 = type$.String;
              t3 = new Uint8Array(0);
              $.keyProviders.$indexSet(0, keyProviderId, new A.KeyProvider(t1, keyProviderOptions, A.LinkedHashMap_LinkedHashMap$_empty(t2, type$.ParticipantKeyHandler), t3));
              J.postMessage$1$x(self.self, A.LinkedHashMap_LinkedHashMap$_literal(["type", "init", "msgId", msgId, "msgType", "response"], t2, type$.nullable_String));
              // goto after switch
              $async$goto = 4;
              break;
            case 6:
              // case
              keyProviderId = A._asString(t1.$index(copy, "keyProviderId"));
              t2.log$4(B.Level_CONFIG_700, "Dispose keyProvider " + keyProviderId, null, null);
              $.keyProviders.remove$1(0, keyProviderId);
              J.postMessage$1$x(self.self, A.LinkedHashMap_LinkedHashMap$_literal(["type", "dispose", "msgId", msgId, "msgType", "response"], type$.String, type$.nullable_String));
              // goto after switch
              $async$goto = 4;
              break;
            case 7:
              ...
              trackId = A._asString(t1.$index(copy, "trackId"));
              t1 = $.participantCryptors;
              t3 = A._arrayInstanceType(t1);
              t4 = t3._eval$1("WhereIterable<1>");
              cryptors = A.List_List$of(new A.WhereIterable(t1, t3._eval$1("bool(1)")._as(new A.main__closure(trackId)), t4), true, t4._eval$1("Iterable.E"));
              for (t1 = cryptors.length, t3 = "" + enabled, t4 = "Set enable " + t3 + " for trackId ", t5 = "setEnabled[" + t3 + string$.___las, _i = 0; _i < t1; ++_i) {
                cryptor = cryptors[_i];
                t2.log$4(B.Level_CONFIG_700, t4 + cryptor.trackId, null, null);
                if (cryptor.lastError !== B.CryptorError_1) {
                  t2.log$4(B.Level_INFO_800, t5, null, null);
                  cryptor.lastError = B.CryptorError_0;
                }
                t2.log$4(B.Level_CONFIG_700, "setEnabled for " + A.S(cryptor.participantIdentity) + ", enabled: " + t3, null, null);
                cryptor._enabled = enabled;
              }
              J.postMessage$1$x(self.self, A.LinkedHashMap_LinkedHashMap$_literal(["type", "cryptorEnabled", "enable", enabled, "msgId", msgId, "msgType", "response"], type$.String, type$.nullable_Object));
              // goto after switch
              $async$goto = 4;
              break;
            case 8:
            ...
            case 9:
              ...
              participantId = A._asString(t1.$index(copy, "participantId"));
              trackId = t1.$index(copy, "trackId");
              ...
              keyProviderId = A._asString(t1.$index(copy, "keyProviderId"));
              t2.log$4(B.Level_CONFIG_700, "SetupTransform for kind " + A.S(kind) + ", trackId " + A.S(trackId) + ", participantId " + participantId + ", " + B.Type_JSObject_8k0.toString$0(0) + " " + B.Type_JSObject_8k0.toString$0(0) + "}", null, null);
              keyProvider = $.keyProviders.$index(0, keyProviderId);
              if (keyProvider == null) {
                t2.log$4(B.Level_WARNING_900, "KeyProvider not found for " + keyProviderId, null, null);
                J.postMessage$1$x(self.self, A.LinkedHashMap_LinkedHashMap$_literal(["type", "cryptorSetup", "participantId", participantId, "trackId", trackId, "exist", exist, "operation", msgType, "error", "KeyProvider not found", "msgId", msgId, "msgType", "response"], type$.String, type$.dynamic));
                // goto return
                $async$goto = 1;
                break;
              }
            ...
            case 22:
              // returning from await.
              J.postMessage$1$x(self.self, A.LinkedHashMap_LinkedHashMap$_literal(["type", "cryptorSetup", "participantId", participantId, "trackId", trackId, "exist", exist, "operation", msgType, "msgId", msgId, "msgType", "response"], type$.String, type$.dynamic));
              cryptor.lastError = B.CryptorError_0;
              // goto after switch
              $async$goto = 4;
              break;
            case 10:
              // case
              trackId = A._asString(t1.$index(copy, "trackId"));
              t2.log$4(B.Level_CONFIG_700, "Removing trackId " + trackId, null, null);
              A.unsetCryptorParticipant(trackId);
              J.postMessage$1$x(self.self, A.LinkedHashMap_LinkedHashMap$_literal(["type", "cryptorRemoved", "trackId", trackId, "msgId", msgId, "msgType", "response"], type$.String, type$.nullable_String));
              // goto after switch
              $async$goto = 4;
              break;
            case 11:
            ...
            case 12:
              ...
              keyIndex = A._asInt(t1.$index(copy, "keyIndex"));
              keyProviderId = A._asString(t1.$index(copy, "keyProviderId"));
              keyProvider = $.keyProviders.$index(0, keyProviderId);
              if (keyProvider == null) {
                t2.log$4(B.Level_WARNING_900, "KeyProvider not found for " + keyProviderId, null, null);
                J.postMessage$1$x(self.self, A.LinkedHashMap_LinkedHashMap$_literal(["type", "setKey", "error", "KeyProvider not found", "msgId", msgId, "msgType", "response"], type$.String, type$.nullable_String));
                // goto return
                $async$goto = 1;
                break;
              }
              t3 = keyProvider.keyProviderOptions.sharedKey;
              t4 = "" + keyIndex;
              $async$goto = t3 ? 23 : 25;
              break;
            case 23:
              // then
              t2.log$4(B.Level_CONFIG_700, "Set SharedKey keyIndex " + t4, null, null);
              t2.log$4(B.Level_INFO_800, "setting shared key", null, null);
            ...
            case 25:
              // else
              participantId = A._asString(t1.$index(copy, "participantId"));
              t2.log$4(B.Level_CONFIG_700, "Set key for participant " + participantId + ", keyIndex " + t4, null, null);
              $async$goto = 26;
            ...
            case 24:
              // join
              J.postMessage$1$x(self.self, A.LinkedHashMap_LinkedHashMap$_literal(["type", "setKey", "participantId", t1.$index(copy, "participantId"), "sharedKey", t3, "keyIndex", keyIndex, "msgId", msgId, "msgType", "response"], type$.String, type$.dynamic));
              // goto after switch
              $async$goto = 4;
              break;
            case 13:
            ...
            case 14:
              // case
              keyIndex = t1.$index(copy, "keyIndex");
              participantId = A._asString(t1.$index(copy, "participantId"));
              keyProviderId = A._asString(t1.$index(copy, "keyProviderId"));
              keyProvider = $.keyProviders.$index(0, keyProviderId);
              if (keyProvider == null) {
              ...
              t1 = keyProvider.keyProviderOptions.sharedKey;
              $async$goto = t1 ? 27 : 29;
              break;
            case 27:
              // then
              t2.log$4(B.Level_CONFIG_700, "RatchetKey for SharedKey, keyIndex " + A.S(keyIndex), null, null);
              $async$goto = 30;
            ...
            case 29:
              // else
              t2.log$4(B.Level_CONFIG_700, "RatchetKey for participant " + participantId + ", keyIndex " + A.S(keyIndex), null, null);
              $async$goto = 31;
            ...
            case 28:
              // join
              t2 = self.self;
              J.postMessage$1$x(t2, A.LinkedHashMap_LinkedHashMap$_literal(["type", "ratchetKey", "sharedKey", t1, "participantId", participantId, "newKey", newKey != null ? B.C_Base64Encoder.convert$1(type$.Base64Codec._eval$1("Codec.S")._as(newKey)) : "", "keyIndex", keyIndex, "msgId", msgId, "msgType", "response"], type$.String, type$.dynamic));
              // goto after switch
              $async$goto = 4;
              break;
            case 15:
              ...
              trackId = A._asString(t1.$index(copy, "trackId"));
              t2.log$4(B.Level_CONFIG_700, "Setup key index for track " + trackId, null, null);
              t1 = $.participantCryptors;
              t3 = A._arrayInstanceType(t1);
              t4 = t3._eval$1("WhereIterable<1>");
              cryptors = A.List_List$of(new A.WhereIterable(t1, t3._eval$1("bool(1)")._as(new A.main__closure0(trackId)), t4), true, t4._eval$1("Iterable.E"));
              for (t1 = cryptors.length, _i = 0; _i < t1; ++_i) {
                c = cryptors[_i];
                t2.log$4(B.Level_CONFIG_700, "Set keyIndex for trackId " + c.trackId, null, null);
                A._asInt(keyIndex);
                if (c.lastError !== B.CryptorError_1) {
                  t2.log$4(B.Level_INFO_800, "setKeyIndex: lastError != CryptorError.kOk, reset state to kNew", null, null);
                  c.lastError = B.CryptorError_0;
                }
                t2.log$4(B.Level_CONFIG_700, "setKeyIndex for " + A.S(c.participantIdentity) + ", newIndex: " + keyIndex, null, null);
                c.currentKeyIndex = keyIndex;
              }
              J.postMessage$1$x(self.self, A.LinkedHashMap_LinkedHashMap$_literal(["type", "setKeyIndex", "keyIndex", keyIndex, "msgId", msgId, "msgType", "response"], type$.String, type$.dynamic));
              // goto after switch
              $async$goto = 4;
              break;
            case 16:
            ...
            case 32:
              // then
              t2.log$4(B.Level_CONFIG_700, "Export SharedKey keyIndex " + t1, null, null);
              $async$goto = 35;
            ...
            case 34:
              // else
              t2.log$4(B.Level_CONFIG_700, "Export key for participant " + participantId + ", keyIndex " + t1, null, null);
              $async$goto = 36;
            ...
            case 33:
              // join
              t1 = self.self;
              J.postMessage$1$x(t1, A.LinkedHashMap_LinkedHashMap$_literal(["type", "exportKey", "participantId", participantId, "keyIndex", keyIndex, "exportedKey", key != null ? B.C_Base64Encoder.convert$1(type$.Base64Codec._eval$1("Codec.S")._as(key)) : "", "msgId", msgId, "msgType", "response"], type$.String, type$.nullable_Object));
              // goto after switch
              $async$goto = 4;
              break;
            case 18:
              // case
              sifTrailer = new Uint8Array(A._ensureNativeList(B.C_Base64Decoder.convert$1(A._asString(t1.$index(copy, "sifTrailer")))));
              keyProviderId = A._asString(t1.$index(copy, "keyProviderId"));
              keyProvider = $.keyProviders.$index(0, keyProviderId);
              if (keyProvider == null) {
                t2.log$4(B.Level_WARNING_900, "KeyProvider not found for " + keyProviderId, null, null);
              ...
              t2.log$4(B.Level_CONFIG_700, "SetSifTrailer = " + A.S(sifTrailer), null, null);
              for (t1 = $.participantCryptors, t3 = t1.length, _i = 0; _i < t1.length; t1.length === t3 || (0, A.throwConcurrentModificationError)(t1), ++_i) {
                c = t1[_i];
                t2.log$4(B.Level_CONFIG_700, "setSifTrailer for " + A.S(c.participantIdentity) + ", magicBytes: " + A.S(sifTrailer), null, null);
                c.keyHandler.keyOptions.uncryptedMagicBytes = sifTrailer;
              }
              J.postMessage$1$x(self.self, A.LinkedHashMap_LinkedHashMap$_literal(["type", "setSifTrailer", "msgId", msgId, "msgType", "response"], type$.String, type$.nullable_String));
              // goto after switch
              $async$goto = 4;
              break;
            case 19:
              ...
              trackId = A._asString(t1.$index(copy, "trackId"));
              t2.log$4(B.Level_CONFIG_700, "Update codec for trackId " + trackId + ", codec " + codec, null, null);
              cryptor = A.IterableExtension_firstWhereOrNull($.participantCryptors, new A.main__closure1(trackId), type$.FrameCryptor);
              if (cryptor != null) {
                if (cryptor.lastError !== B.CryptorError_1) {
                  t2.log$4(B.Level_INFO_800, "updateCodec[" + codec + string$.___las, null, null);
                  cryptor.lastError = B.CryptorError_0;
                }
                t2.log$4(B.Level_CONFIG_700, "updateCodec for " + A.S(cryptor.participantIdentity) + ", codec: " + codec, null, null);
                cryptor.codec = codec;
              }
              J.postMessage$1$x(self.self, A.LinkedHashMap_LinkedHashMap$_literal(["type", "updateCodec", "msgId", msgId, "msgType", "response"], type$.String, type$.nullable_String));
              // goto after switch
              $async$goto = 4;
              break;
            case 20:
              // case
              trackId = A._asString(t1.$index(copy, "trackId"));
              t2.log$4(B.Level_CONFIG_700, "Dispose for trackId " + trackId, null, null);
              ...
              if (cryptor != null) {
                ...
                J.postMessage$1$x(self.self, A.LinkedHashMap_LinkedHashMap$_literal(["type", "cryptorDispose", "participantId", cryptor.participantIdentity, "trackId", trackId, "msgId", msgId, "msgType", "response"], t1, t2));
              } else
                J.postMessage$1$x(self.self, A.LinkedHashMap_LinkedHashMap$_literal(["type", "cryptorDispose", "error", "cryptor not found", "msgId", msgId, "msgType", "response"], t1, t2));
              // goto after switch
              $async$goto = 4;
              break;
            case 21:
              // default
              t2.log$4(B.Level_WARNING_900, "Unknown message kind " + A.S(copy), null, null);
            case 4:
              // after switch
            case 1:
              // return
  ...
  (function installTearOffs() {
    ...
    var _;
    _instance_2_u(_ = A.FrameCryptor.prototype, "get$encodeFunction", "encodeFunction$2", 8);
    _instance_2_u(_, "get$decodeFunction", "decodeFunction$2", 8);
  })();
  (function inheritance() {
    ...
    _inheritMany(A.Closure, [A.Closure2Args, A.Closure0Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._awaitOnObject_closure, A._SyncBroadcastStreamController__sendData_closure, A._Future__chainForeignFuture_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A._EventStreamSubscription_closure, A.jsify__convert, A.promiseToFuture_closure, A.promiseToFuture_closure0, A.getTrackCryptor_closure, A.unsetCryptorParticipant_closure, A.main_closure, A.main_closure0, A.main_closure1, A.main__closure, A.main__closure0, A.main__closure1, A.main__closure2]);
