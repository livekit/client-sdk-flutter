...
(function dartProgram() {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t3 = type$.String;
              t4 = type$.JSObject;
              transformer = t4._as(new t1(t4._as(A.jsify(A.LinkedHashMap_LinkedHashMap$_literal(["transform", t2], t3, type$.Future_void_Function_JSObject_JSObject)))));
              try {
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 7:
              ...
              cryptors = A.List_List$of(new A.WhereIterable(t2, t3._eval$1("bool(1)")._as(new A.main_handleMessage_closure(trackId)), t4), true, t4._eval$1("Iterable.E"));
            ...
            case 15:
              ...
              t3 = A._arrayInstanceType(t2);
              t4 = t3._eval$1("WhereIterable<1>");
              cryptors = A.List_List$of(new A.WhereIterable(t2, t3._eval$1("bool(1)")._as(new A.main_handleMessage_closure0(trackId)), t4), true, t4._eval$1("Iterable.E"));
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "bool(FrameCryptor)", "Null(@)", "~(@)", "~(~())", "Null()", "~(Object,StackTrace)", "Null(Object,StackTrace)", "Object?(Object?)", "Future<~>(JSObject,JSObject)", "Future<~>()", "Null(JSObject)", "@(@)", "@(@,String)", "@(String)", "Null(~())", "Null(@,StackTrace)", "~(int,@)", "~(Object?,Object?)", "Logger()", "~(LogRecord)", "Future<Null>(JSObject)"],
