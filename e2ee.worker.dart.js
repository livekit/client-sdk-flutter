...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    getTrackCryptor(participantIdentity, trackId, keyProvider) {
      ...
      if (cryptor == null) {
        ...
        t1 = type$.JSObject._as(init.G.self);
        t2 = type$.int;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t3._as(t2.self).onmessage = A._functionToJS1(new A.main_closure1(new A.main_handleMessage()));
              // implicit return
    ...
    main_handleMessage: function main_handleMessage() {
    },
    main_handleMessage_closure: function main_handleMessage_closure(t0) {
      this.trackId = t0;
    },
    main_handleMessage_closure0: function main_handleMessage_closure0(t0) {
      this.trackId = t0;
    },
    main_handleMessage_closure1: function main_handleMessage_closure1(t0) {
      this.trackId = t0;
    },
    main_handleMessage_closure2: function main_handleMessage_closure2(t0) {
      this.trackId = t0;
    },
  ...
  A.FrameCryptor.prototype = {
    ...
    getUnencryptedBytes$2(obj, codec) {
      var naluIndices, t1, t2, _i, index, type, _null = null,
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1 = $.$get$logger();
              t1.log$4(B.Level_FINER_400, "encodeFunction: buffer " + srcFrame.buffer.length + ", synchronizationSource " + srcFrame.ssrc + " frameType " + srcFrame.frameType, null, null);
    ...
    decodeFunction$body$FrameCryptor(frameObj, controller) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, $async$handler = 2, $async$errorStack = [], $async$self = this, headerLength, frameTrailer, ivLength, keyIndex, iv, decryptFrameInternal, ratchedKeyInternal, e, finalBuffer, e0, s, t2, t3, t4, t5, t6, magicBytesBuffer, t7, initialKeySet, exception, t1, srcFrame, $async$exception, $async$exception1;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1.ratchetCount = 0;
              t2 = $.$get$logger();
              t2.log$4(B.Level_FINER_400, "decodeFunction: frame length " + srcFrame.buffer.length, null, null);
              ...
              if (!$async$self.get$enabled() || srcFrame.buffer.length === 0) {
                ...
                t2.log$4(B.Level_FINE_500, "enqueing empty dtx frame", null, null);
                controller.enqueue(frameObj);
                // goto return
                $async$goto = 1;
                break;
                ...
                if (t4.length > t6) {
                  ...
                  if (A.Iterable_iterableToFullString(magicBytesBuffer, "[", "]") === A.Iterable_iterableToFullString(t3, "[", "]")) {
                    ...
                    if (t1) {
                      ...
                      t2.log$4(B.Level_FINE_500, "encodeFunction: SIF limit reached, dropping frame", null, null);
                      // goto return
                      $async$goto = 1;
                      break;
                    }
            ...
            case 4:
              ...
              $.$get$logger().log$4(B.Level_INFO_800, "decodeFunction[CryptorError.kDecryptError]: " + A.S(e0) + ", " + A.S(s), null, null);
  ...
  A.ParticipantKeyHandler.prototype = {
    ...
    ratchetMaterial$2(currentMaterial, newKeyBuffer) {
      return this.ratchetMaterial$body$ParticipantKeyHandler(currentMaterial, newKeyBuffer);
    },
    ratchetMaterial$body$ParticipantKeyHandler(currentMaterial, newKeyBuffer) {
      var $async$goto = 0,
    ...
    setKey$2$keyIndex(key, keyIndex) {
      return this.setKey$body$ParticipantKeyHandler(key, keyIndex);
    },
    setKey$1(key) {
      return this.setKey$2$keyIndex(key, 0);
    },
    setKey$body$ParticipantKeyHandler(key, keyIndex) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
    ...
    setKeySetFromMaterial$2(keySet, keyIndex) {
      return this.setKeySetFromMaterial$body$ParticipantKeyHandler(keySet, keyIndex);
    },
    setKeySetFromMaterial$body$ParticipantKeyHandler(keySet, keyIndex) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$self = this, t1;
    ...
    deriveKeys$2(material, salt) {
      return this.deriveKeys$body$ParticipantKeyHandler(material, salt);
    },
    deriveKeys$body$ParticipantKeyHandler(material, salt) {
      var $async$goto = 0,
    ...
    ratchet$2(material, salt) {
      return this.ratchet$body$ParticipantKeyHandler(material, salt);
    },
    ratchet$body$ParticipantKeyHandler(material, salt) {
      var $async$goto = 0,
  ...
  A.main_handleMessage.prototype = {
    $call$body$main_handleMessage(e) {
      var $async$goto = 0,
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 6:
              ...
              type$.JSObject._as(init.G.self).postMessage(A.jsify(A.LinkedHashMap_LinkedHashMap$_literal(["type", "dispose", "msgId", msgId, "msgType", "response"], type$.String, type$.nullable_String)));
              // goto after switch
              $async$goto = 4;
              break;
            case 7:
              ...
              cryptors = A.List_List$_of(new A.WhereIterable(t2, t3._eval$1("bool(1)")._as(new A.main_handleMessage_closure(trackId)), t4), t4._eval$1("Iterable.E"));
              for (t2 = cryptors.length, t3 = "" + enabled, t4 = "Set enable " + t3 + " for trackId ", t5 = "setEnabled[" + t3 + string$.___las, _i = 0; _i < cryptors.length; cryptors.length === t2 || (0, A.throwConcurrentModificationError)(cryptors), ++_i) {
                cryptor = cryptors[_i];
              ...
              type$.JSObject._as(init.G.self).postMessage(A.jsify(A.LinkedHashMap_LinkedHashMap$_literal(["type", "cryptorEnabled", "enable", enabled, "msgId", msgId, "msgType", "response"], type$.String, type$.nullable_Object)));
              // goto after switch
              $async$goto = 4;
              break;
            case 8:
            ...
            case 9:
              ...
              if (keyProvider == null) {
                ...
                t2._as(init.G.self).postMessage(A.jsify(A.LinkedHashMap_LinkedHashMap$_literal(["type", "cryptorSetup", "participantId", participantId, "trackId", trackId, "exist", exist, "operation", msgType, "error", "KeyProvider not found", "msgId", msgId, "msgType", "response"], type$.String, type$.dynamic)));
                // goto return
                $async$goto = 1;
                break;
              }
            ...
            case 22:
              // returning from await.
              t2._as(init.G.self).postMessage(A.jsify(A.LinkedHashMap_LinkedHashMap$_literal(["type", "cryptorSetup", "participantId", participantId, "trackId", trackId, "exist", exist, "operation", msgType, "msgId", msgId, "msgType", "response"], type$.String, type$.dynamic)));
              cryptor.lastError = B.CryptorError_0;
              // goto after switch
              $async$goto = 4;
              break;
            case 10:
              ...
              type$.JSObject._as(init.G.self).postMessage(A.jsify(A.LinkedHashMap_LinkedHashMap$_literal(["type", "cryptorRemoved", "trackId", trackId, "msgId", msgId, "msgType", "response"], type$.String, type$.nullable_String)));
              // goto after switch
              $async$goto = 4;
              break;
            case 11:
            ...
            case 12:
              ...
              if (keyProvider == null) {
                t1.log$4(B.Level_WARNING_900, "KeyProvider not found for " + keyProviderId, null, null);
                type$.JSObject._as(init.G.self).postMessage(A.jsify(A.LinkedHashMap_LinkedHashMap$_literal(["type", "setKey", "error", "KeyProvider not found", "msgId", msgId, "msgType", "response"], type$.String, type$.nullable_String)));
                // goto return
                $async$goto = 1;
                break;
              }
            ...
            case 24:
              // join
              type$.JSObject._as(init.G.self).postMessage(A.jsify(A.LinkedHashMap_LinkedHashMap$_literal(["type", "setKey", "participantId", msg.$index(0, "participantId"), "sharedKey", t2, "keyIndex", keyIndex, "msgId", msgId, "msgType", "response"], type$.String, type$.dynamic)));
              // goto after switch
              $async$goto = 4;
              break;
            case 13:
            ...
            case 15:
              ...
              t3 = A._arrayInstanceType(t2);
              t4 = t3._eval$1("WhereIterable<1>");
              cryptors = A.List_List$_of(new A.WhereIterable(t2, t3._eval$1("bool(1)")._as(new A.main_handleMessage_closure0(trackId)), t4), t4._eval$1("Iterable.E"));
              ...
              type$.JSObject._as(init.G.self).postMessage(A.jsify(A.LinkedHashMap_LinkedHashMap$_literal(["type", "setKeyIndex", "keyIndex", keyIndex, "msgId", msgId, "msgType", "response"], type$.String, type$.dynamic)));
              // goto after switch
              $async$goto = 4;
              break;
            case 16:
            ...
            case 18:
              ...
              type$.JSObject._as(init.G.self).postMessage(A.jsify(A.LinkedHashMap_LinkedHashMap$_literal(["type", "setSifTrailer", "msgId", msgId, "msgType", "response"], type$.String, type$.nullable_String)));
              // goto after switch
              $async$goto = 4;
              break;
            case 19:
              ...
              cryptor = A.IterableExtension_firstWhereOrNull($.participantCryptors, new A.main_handleMessage_closure1(trackId), type$.FrameCryptor);
              if (cryptor != null) {
                if (cryptor.lastError !== B.CryptorError_1) {
              ...
              type$.JSObject._as(init.G.self).postMessage(A.jsify(A.LinkedHashMap_LinkedHashMap$_literal(["type", "updateCodec", "msgId", msgId, "msgType", "response"], type$.String, type$.nullable_String)));
              // goto after switch
              $async$goto = 4;
              break;
            case 20:
              ...
              cryptor = A.IterableExtension_firstWhereOrNull($.participantCryptors, new A.main_handleMessage_closure2(trackId), type$.FrameCryptor);
              t1 = init.G;
              t2 = type$.JSObject;
              t3 = type$.String;
              ...
              if (cryptor != null) {
                ...
                t2._as(t1.self).postMessage(A.jsify(A.LinkedHashMap_LinkedHashMap$_literal(["type", "cryptorDispose", "participantId", cryptor.participantIdentity, "trackId", trackId, "msgId", msgId, "msgType", "response"], t3, t4)));
              } else
                t2._as(t1.self).postMessage(A.jsify(A.LinkedHashMap_LinkedHashMap$_literal(["type", "cryptorDispose", "error", "cryptor not found", "msgId", msgId, "msgType", "response"], t3, t4)));
              // goto after switch
              $async$goto = 4;
              break;
            case 21:
    ...
    call$1(e) {
      return this.$call$body$main_handleMessage(e);
    },
    $signature: 21
  };
  A.main_handleMessage_closure.prototype = {
    call$1(c) {
      return type$.FrameCryptor._as(c).trackId === this.trackId;
    },
    $signature: 1
  };
  A.main_handleMessage_closure0.prototype = {
    call$1(c) {
      return type$.FrameCryptor._as(c).trackId === this.trackId;
    },
    $signature: 1
  };
  A.main_handleMessage_closure1.prototype = {
    call$1(c) {
      return type$.FrameCryptor._as(c).trackId === this.trackId;
    },
    $signature: 1
  };
  A.main_handleMessage_closure2.prototype = {
    call$1(c) {
      return type$.FrameCryptor._as(c).trackId === this.trackId;
    },
    $signature: 1
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._awaitOnObject_closure, A._SyncBroadcastStreamController__sendData_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A.jsify__convert, A.promiseToFuture_closure, A.promiseToFuture_closure0, A.dartify_convert, A.getTrackCryptor_closure, A.unsetCryptorParticipant_closure, A.main_closure, A.main_closure0, A.main_handleMessage, A.main_handleMessage_closure, A.main_handleMessage_closure0, A.main_handleMessage_closure1, A.main_handleMessage_closure2, A.main_closure1]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "bool(FrameCryptor)", "~(@)", "~(~())", "Null(@)", "Null()", "~(Object,StackTrace)", "Object?(Object?)", "~(JSObject,JSObject)", "Future<~>()", "Null(JSObject)", "@(@)", "@(@,String)", "@(String)", "Null(~())", "Null(@,StackTrace)", "~(int,@)", "Null(Object,StackTrace)", "~(Object?,Object?)", "Logger()", "~(LogRecord)", "Future<Null>(JSObject)"],
