// Generated by dart2js (, csp, intern-composite-values), the Dart to JavaScript compiler version: 3.13.2.
...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    Algorithm: function Algorithm(t0, t1) {
      this.index = t0;
      this._name = t1;
    },
    ...
    E2EEDataPacketCryptor_decrypt_ratchetKeyInternal: function E2EEDataPacketCryptor_decrypt_ratchetKeyInternal(t0, t1, t2, t3) {
      var _ = this;
      _._box_1 = t0;
      _._box_0 = t1;
      _.$this = t2;
    ...
    CryptorError: function CryptorError(t0, t1) {
      this.index = t0;
      this._name = t1;
    },
    ...
    FrameCryptor_decodeFunction_ratchetKeyInternal: function FrameCryptor_decodeFunction_ratchetKeyInternal(t0, t1, t2, t3) {
      var _ = this;
      _._box_1 = t0;
      _._box_0 = t1;
      _.$this = t2;
  ...
  A.E2EEDataPacketCryptor.prototype = {
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              iv0.setUint32(0, $.$get$Random__secureRandom().nextInt$1(Math.max(0, 4294967295)) >>> 0, false);
    ...
    decrypt$body$E2EEDataPacketCryptor(keys, encryptedPacket) {
      var $async$goto = 0,
        ...
        $async$returnValue, $async$handler = 2, $async$errorStack = [], $async$self = this, initialKeyIndex, ivLength, keyIndex, iv, payload, decryptFrameInternal, ratchetKeyInternal, e, t2, t3, t4, t5, initialKeySet, exception, t1, $async$exception, $async$exception1;
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              t2.log$4(B.Level_FINE_500, "decodeFunction: data packet length " + t3.length, null, null);
              ...
              ratchetKeyInternal = new A.E2EEDataPacketCryptor_decrypt_ratchetKeyInternal(t1, t4, $async$self, decryptFrameInternal);
              $async$handler = 8;
              $async$goto = 11;
            ...
            case 8:
              ...
              $async$goto = 12;
              return A._asyncAwait(ratchetKeyInternal.call$0(), $async$decrypt$2);
            case 12:
              // returning from await.
              // goto after finally
              $async$goto = 10;
  ...
  A.E2EEDataPacketCryptor_decrypt_ratchetKeyInternal.prototype = {
    call$0() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
  ...
  A.FrameCryptor.prototype = {
    ...
    setupTransform$body$FrameCryptor(codec, isReuse, kind, operation, readable, trackId, writable) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, $async$self = this, transformer, e, t2, t3, exception, t1;
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              t3 = type$.String;
              transformer = A._asJSObject(new t1(A._asJSObject(A.jsify(A.LinkedHashMap_LinkedHashMap$_literal(["transform", t2], t3, type$.JavaScriptFunction)))));
              try {
    ...
    getUnencryptedBytes$2(obj, codec) {
      ...
      if (A.JSAnyUtilityExtension_instanceOfString(obj, "RTCEncodedVideoFrame")) {
        data = A.NativeUint8List_NativeUint8List$view(type$.NativeArrayBuffer._as(obj.data), 0, _null);
        if ("type" in obj) {
    ...
    readFrameInfo$1(frameObj) {
      ...
      if (A.JSAnyUtilityExtension_instanceOfString(frameObj, "RTCEncodedVideoFrame")) {
        buffer = A.NativeUint8List_NativeUint8List$view(type$.NativeArrayBuffer._as(frameObj.data), 0, _null);
        if ("type" in frameObj) {
          frameType = A._asString(frameObj.type);
          $.$get$logger().log$4(B.Level_FINER_400, "frameType: " + frameType, _null, _null);
        } else
          frameType = "";
        meta = A._asJSObject(frameObj.getMetadata());
    ...
    decodeFunction$body$FrameCryptor(frameObj, controller) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, $async$handler = 2, $async$errorStack = [], $async$self = this, headerLength, frameTrailer, ivLength, keyIndex, iv, decryptFrameInternal, ratchetKeyInternal, e, finalBuffer, e0, s, t2, t3, t4, t5, t6, magicBytesBuffer, t7, initialKeySet, exception, t1, srcFrame, $async$exception, $async$exception1;
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              t1.ratchetCount = 0;
              t2 = $.$get$logger();
              t2.log$4(B.Level_FINE_500, "decodeFunction: frame length " + srcFrame.buffer.length, null, null);
              t1.initialKeySet = t1.decrypted = null;
              ...
              if (!$async$self.get$enabled() || srcFrame.buffer.length === 0) {
                ...
                t2.log$4(B.Level_FINE_500, "enqueuing empty dtx frame", null, null);
                controller.enqueue(frameObj);
                // goto return
                $async$goto = 1;
                break;
                ...
                if (t4.length > t6) {
                  ...
                  if (A.Iterable_iterableToFullString(magicBytesBuffer, "[", "]") === A.Iterable_iterableToFullString(t3, "[", "]")) {
                    ...
                    if (t1) {
                      ...
                      t2.log$4(B.Level_FINER_400, "decodeFunction: skip unencrypted frame, type " + t1[0], null, null);
                      ...
                      t2.log$4(B.Level_FINE_500, "decodeFunction: enqueuing silent frame src: " + A.S(srcFrame.buffer), null, null);
                      $async$self.enqueueFrame$3(frameObj, controller, finalBuffer);
                      t2.log$4(B.Level_FINE_500, "decodeFunction: enqueuing done", null, null);
                      // goto return
                      $async$goto = 1;
                      break;
                    } else {
                      t2.log$4(B.Level_WARNING_900, "decodeFunction: SIF limit reached, dropping frame", null, null);
                      // goto return
                      $async$goto = 1;
                      break;
                    }
              ...
              ratchetKeyInternal = new A.FrameCryptor_decodeFunction_ratchetKeyInternal(t1, t3, $async$self, decryptFrameInternal);
              $async$handler = 8;
              $async$goto = 11;
            ...
            case 8:
              ...
              t2.log$4(B.Level_FINER_400, "decodeFunction: kInternalError catch " + A.S(e), null, null);
              $async$goto = 12;
              return A._asyncAwait(ratchetKeyInternal.call$0(), $async$decodeFunction$2);
            case 12:
              // returning from await.
              // goto after finally
              $async$goto = 10;
            ...
            case 4:
              ...
              $.$get$logger().log$4(B.Level_WARNING_900, "decodeFunction[CryptorError.kDecryptError]: " + A.S(e0) + ", " + A.S(s), null, null);
  ...
  A.FrameCryptor_decodeFunction_ratchetKeyInternal.prototype = {
    call$0() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$self = this, newKeyBuffer, newMaterial, t1, t2, t3, t4, t5, t6, $async$temp1;
  ...
  A.main_closure0.prototype = {
    call$1($event) {
      ...
      cryptor.setupTransform$7$codec$isReuse$kind$operation$readable$trackId$writable(codec == null ? _null : codec, false, kind, msgType, t1, trackId, t2);
    },
    $signature: 11
  };
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Closure0Args, [A._AsyncRun__scheduleImmediateJsOverride_internalCallback, A._AsyncRun__scheduleImmediateWithSetImmediate_internalCallback, A._TimerImpl_internalCallback, A._Future__addListener_closure, A._Future__prependListeners_closure, A._Future__chainCoreFuture_closure, A._Future__asyncCompleteWithValue_closure, A._Future__asyncCompleteErrorObject_closure, A._Future__propagateToListeners_handleWhenCompleteCallback, A._Future__propagateToListeners_handleValueCallback, A._Future__propagateToListeners_handleError, A.Stream_length_closure0, A._PendingEvents_schedule_closure, A._RootZone_bindCallbackGuarded_closure, A._rootHandleError_closure, A.Logger_Logger_closure, A.E2EEDataPacketCryptor_decrypt_decryptFrameInternal, A.E2EEDataPacketCryptor_decrypt_ratchetKeyInternal, A.FrameCryptor_decodeFunction_decryptFrameInternal, A.FrameCryptor_decodeFunction_ratchetKeyInternal]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "bool(FrameCryptor)", "Future<~>()", "~(@)", "~(~())", "Null(@)", "Null()", "~(Object,StackTrace)", "Object?(Object?)", "~(JSObject,JSObject)", "bool(E2EEDataPacketCryptor)", "Null(JSObject)", "bool(Algorithm)", "@(@)", "@(@,String)", "@(String)", "Null(~())", "Null(@,StackTrace)", "~(int,@)", "Null(Object,StackTrace)", "~(Object?,Object?)", "Logger()", "~(LogRecord)", "Future<Null>(JSObject)"],
  ...
  var string$ = {
    ...
    x5bdecod: "[decodeFunction] decryption failed even after ratcheting",
    x5bratch: "[ratchetKeyInternal] cannot ratchet anymore",
...
;
    ...
    B.CryptorError_0 = new A.CryptorError(0, "kNew");
    B.CryptorError_1 = new A.CryptorError(1, "kOk");
    B.CryptorError_2 = new A.CryptorError(2, "kDecryptError");
    B.CryptorError_3 = new A.CryptorError(3, "kEncryptError");
    B.CryptorError_4 = new A.CryptorError(4, "kUnsupportedCodec");
    B.CryptorError_5 = new A.CryptorError(5, "kMissingKey");
    B.CryptorError_6 = new A.CryptorError(6, "kKeyRatcheted");
    B.CryptorError_7 = new A.CryptorError(7, "kInternalError");
    B.CryptorError_8 = new A.CryptorError(8, "kDisposed");
    ...
    B.Algorithm_0 = new A.Algorithm(0, "kAesGcm");
    B.Algorithm_1 = new A.Algorithm(1, "kAesCbc");
