...
AgentAttributes _$AgentAttributesFromJson(Map<String, dynamic> json) =>
    AgentAttributes(
      lkAgentInputs: (json['lk.agent.inputs'] as List<dynamic>?)
          ?.map((e) => $enumDecode(_$AgentInputEnumMap, e))
          .toList(),
      lkAgentOutputs: (json['lk.agent.outputs'] as List<dynamic>?)
...
Map<String, dynamic> _$AgentAttributesToJson(AgentAttributes instance) =>
    <String, dynamic>{
      if (instance.lkAgentInputs?.map((e) => _$AgentInputEnumMap[e]!).toList()
          case final value?)
        'lk.agent.inputs': value,
      if (instance.lkAgentOutputs?.map((e) => _$AgentOutputEnumMap[e]!).toList()
          case final value?)
        'lk.agent.outputs': value,
      if (_$AgentStateEnumMap[instance.lkAgentState] case final value?)
        'lk.agent.state': value,
      if (instance.lkPublishOnBehalf case final value?)
        'lk.publish_on_behalf': value,
    };
...
Map<String, dynamic> _$TranscriptionAttributesToJson(
    ...
    <String, dynamic>{
      ...
      if (instance.lkTranscribedTrackId case final value?)
        'lk.transcribed_track_id': value,
      if (instance.lkTranscriptionFinal case final value?)
        'lk.transcription_final': value,
    };
