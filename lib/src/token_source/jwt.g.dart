...
LiveKitVideoGrant _$LiveKitVideoGrantFromJson(Map<String, dynamic> json) =>
    LiveKitVideoGrant(
      ...
      canPublishSources: (json['can_publish_sources'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
...
Map<String, dynamic> _$LiveKitVideoGrantToJson(LiveKitVideoGrant instance) =>
    <String, dynamic>{
      ...
      if (instance.canPublishSources case final value?)
        'can_publish_sources': value,
