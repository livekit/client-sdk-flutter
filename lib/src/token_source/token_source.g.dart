...
Map<String, dynamic> _$TokenRequestOptionsToJson(
    ...
    <String, dynamic>{
      ...
      if (instance.participantIdentity case final value?)
        'participantIdentity': value,
      if (instance.participantMetadata case final value?)
        'participantMetadata': value,
      if (instance.participantAttributes case final value?)
        'participantAttributes': value,
...
Map<String, dynamic> _$TokenSourceRequestToJson(TokenSourceRequest instance) =>
    <String, dynamic>{
      ...
      if (instance.participantAttributes case final value?)
        'participant_attributes': value,
      if (instance.roomConfiguration?.toJson() case final value?)
        'room_config': value,
    };
