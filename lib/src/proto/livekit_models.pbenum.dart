...
class DisconnectReason extends $pb.ProtobufEnum {
  ...
  static const DisconnectReason AGENT_ERROR =
      DisconnectReason._(16, _omitEnumNames ? '' : 'AGENT_ERROR');
...
class PacketTrailerFeature extends $pb.ProtobufEnum {
  ...
  static const PacketTrailerFeature PTF_FRAME_ID =
      PacketTrailerFeature._(1, _omitEnumNames ? '' : 'PTF_FRAME_ID');
  ...
  static final $core.List<PacketTrailerFeature?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 1);
...
class ClientInfo_Capability extends $pb.ProtobufEnum {
  static const ClientInfo_Capability CAP_UNUSED =
      ClientInfo_Capability._(0, _omitEnumNames ? '' : 'CAP_UNUSED');
  static const ClientInfo_Capability CAP_PACKET_TRAILER =
      ClientInfo_Capability._(1, _omitEnumNames ? '' : 'CAP_PACKET_TRAILER');

  static const $core.List<ClientInfo_Capability> values =
      <ClientInfo_Capability>[
    CAP_UNUSED,
    CAP_PACKET_TRAILER,
  ];

  static final $core.List<ClientInfo_Capability?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 1);
