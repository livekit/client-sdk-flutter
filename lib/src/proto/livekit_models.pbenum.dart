...
class AudioCodec extends $pb.ProtobufEnum {
  static const AudioCodec DEFAULT_AC = AudioCodec._(
      0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'DEFAULT_AC');
  static const AudioCodec OPUS =
      AudioCodec._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'OPUS');
  static const AudioCodec AAC =
      AudioCodec._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'AAC');
...
class VideoCodec extends $pb.ProtobufEnum {
  static const VideoCodec DEFAULT_VC = VideoCodec._(
      0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'DEFAULT_VC');
  static const VideoCodec H264_BASELINE = VideoCodec._(
      1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'H264_BASELINE');
  static const VideoCodec H264_MAIN = VideoCodec._(
      2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'H264_MAIN');
  static const VideoCodec H264_HIGH = VideoCodec._(
      3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'H264_HIGH');
  static const VideoCodec VP8 =
      VideoCodec._(4, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'VP8');
...
class TrackSource extends $pb.ProtobufEnum {
  ...
  static const TrackSource CAMERA = TrackSource._(
      1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'CAMERA');
  static const TrackSource MICROPHONE = TrackSource._(
      2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'MICROPHONE');
  static const TrackSource SCREEN_SHARE = TrackSource._(
      3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SCREEN_SHARE');
  static const TrackSource SCREEN_SHARE_AUDIO = TrackSource._(
      4, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SCREEN_SHARE_AUDIO');
...
class VideoQuality extends $pb.ProtobufEnum {
  ...
  static const VideoQuality OFF =
      VideoQuality._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'OFF');
...
class ConnectionQuality extends $pb.ProtobufEnum {
  static const ConnectionQuality POOR = ConnectionQuality._(
      0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'POOR');
  static const ConnectionQuality GOOD = ConnectionQuality._(
      1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'GOOD');
  static const ConnectionQuality EXCELLENT = ConnectionQuality._(
      2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'EXCELLENT');
...
class ClientConfigSetting extends $pb.ProtobufEnum {
  static const ClientConfigSetting UNSET = ClientConfigSetting._(
      0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UNSET');
  static const ClientConfigSetting DISABLED = ClientConfigSetting._(
      1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'DISABLED');
  static const ClientConfigSetting ENABLED = ClientConfigSetting._(
      2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'ENABLED');
...
class DisconnectReason extends $pb.ProtobufEnum {
  static const DisconnectReason UNKNOWN_REASON = DisconnectReason._(
      0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UNKNOWN_REASON');
  static const DisconnectReason CLIENT_INITIATED = DisconnectReason._(
      1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'CLIENT_INITIATED');
  static const DisconnectReason DUPLICATE_IDENTITY = DisconnectReason._(
      2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'DUPLICATE_IDENTITY');
  static const DisconnectReason SERVER_SHUTDOWN = DisconnectReason._(
      3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SERVER_SHUTDOWN');
  static const DisconnectReason PARTICIPANT_REMOVED = DisconnectReason._(
      4, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PARTICIPANT_REMOVED');
  static const DisconnectReason ROOM_DELETED = DisconnectReason._(
      5, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'ROOM_DELETED');
  static const DisconnectReason STATE_MISMATCH = DisconnectReason._(
      6, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'STATE_MISMATCH');
  static const DisconnectReason JOIN_FAILURE = DisconnectReason._(
      7, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'JOIN_FAILURE');
...
class ReconnectReason extends $pb.ProtobufEnum {
  static const ReconnectReason RR_UNKOWN = ReconnectReason._(
      0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'RR_UNKOWN');
  static const ReconnectReason RR_SIGNAL_DISCONNECTED = ReconnectReason._(1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'RR_SIGNAL_DISCONNECTED');
  static const ReconnectReason RR_PUBLISHER_FAILED = ReconnectReason._(
      2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'RR_PUBLISHER_FAILED');
  static const ReconnectReason RR_SUBSCRIBER_FAILED = ReconnectReason._(3,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'RR_SUBSCRIBER_FAILED');
  static const ReconnectReason RR_SWITCH_CANDIDATE = ReconnectReason._(
      4, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'RR_SWITCH_CANDIDATE');
...
class Encryption_Type extends $pb.ProtobufEnum {
  ...
  static const Encryption_Type GCM = Encryption_Type._(
      1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'GCM');
  static const Encryption_Type CUSTOM = Encryption_Type._(
      2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'CUSTOM');
...
class ServerInfo_Edition extends $pb.ProtobufEnum {
  static const ServerInfo_Edition Standard = ServerInfo_Edition._(
      0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'Standard');
  static const ServerInfo_Edition Cloud = ServerInfo_Edition._(
      1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'Cloud');
...
class ClientInfo_SDK extends $pb.ProtobufEnum {
  ...
  static const ClientInfo_SDK JS =
      ClientInfo_SDK._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'JS');
  static const ClientInfo_SDK SWIFT = ClientInfo_SDK._(
      2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SWIFT');
  static const ClientInfo_SDK ANDROID = ClientInfo_SDK._(
      3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'ANDROID');
  static const ClientInfo_SDK FLUTTER = ClientInfo_SDK._(
      4, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'FLUTTER');
  static const ClientInfo_SDK GO =
      ClientInfo_SDK._(5, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'GO');
  static const ClientInfo_SDK UNITY = ClientInfo_SDK._(
      6, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UNITY');
