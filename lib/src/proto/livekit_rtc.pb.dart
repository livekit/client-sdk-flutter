...
class SignalRequest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(9)
  set simulcast(SetSimulcastLayers v) { setField(9, v); }
  @$pb.TagNumber(9)
...
class SignalResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(7)
  set speaker(ActiveSpeakerUpdate v) { setField(7, v); }
  @$pb.TagNumber(7)
...
class SetSimulcastLayers extends $pb.GeneratedMessage {
  ...
  factory SetSimulcastLayers.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SetSimulcastLayers.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SetSimulcastLayers copyWith(void Function(SetSimulcastLayers) updates) => super.copyWith((message) => updates(message as SetSimulcastLayers)) as SetSimulcastLayers; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static SetSimulcastLayers getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SetSimulcastLayers>(create);
