...
final $typed_data.Uint8List streamStateDescriptor = $convert.base64Decode('CgtTdHJlYW1TdGF0ZRIKCgZBQ1RJVkUQABIKCgZQQVVTRUQQAQ==');
@$core.Deprecated('Use candidateProtocolDescriptor instead')
const CandidateProtocol$json = const {
  '1': 'CandidateProtocol',
  '2': const [
    const {'1': 'UDP', '2': 0},
    const {'1': 'TCP', '2': 1},
...
const SignalRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'update_layers', '3': 10, '4': 1, '5': 11, '6': '.livekit.UpdateVideoLayers', '9': 0, '10': 'updateLayers'},
    const {'1': 'subscription_permission', '3': 11, '4': 1, '5': 11, '6': '.livekit.SubscriptionPermission', '9': 0, '10': 'subscriptionPermission'},
    const {'1': 'sync_state', '3': 12, '4': 1, '5': 11, '6': '.livekit.SyncState', '9': 0, '10': 'syncState'},
    const {'1': 'simulate', '3': 13, '4': 1, '5': 11, '6': '.livekit.SimulateScenario', '9': 0, '10': 'simulate'},
    const {'1': 'ping', '3': 14, '4': 1, '5': 3, '9': 0, '10': 'ping'},
    const {'1': 'update_metadata', '3': 15, '4': 1, '5': 11, '6': '.livekit.UpdateParticipantMetadata', '9': 0, '10': 'updateMetadata'},
    const {'1': 'ping_req', '3': 16, '4': 1, '5': 11, '6': '.livekit.Ping', '9': 0, '10': 'pingReq'},
  ],
  '8': const [
    const {'1': 'message'},
  ],
...
const SignalResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'leave', '3': 8, '4': 1, '5': 11, '6': '.livekit.LeaveRequest', '9': 0, '10': 'leave'},
    const {'1': 'mute', '3': 9, '4': 1, '5': 11, '6': '.livekit.MuteTrackRequest', '9': 0, '10': 'mute'},
    const {'1': 'speakers_changed', '3': 10, '4': 1, '5': 11, '6': '.livekit.SpeakersChanged', '9': 0, '10': 'speakersChanged'},
    const {'1': 'room_update', '3': 11, '4': 1, '5': 11, '6': '.livekit.RoomUpdate', '9': 0, '10': 'roomUpdate'},
    const {'1': 'connection_quality', '3': 12, '4': 1, '5': 11, '6': '.livekit.ConnectionQualityUpdate', '9': 0, '10': 'connectionQuality'},
    const {'1': 'stream_state_update', '3': 13, '4': 1, '5': 11, '6': '.livekit.StreamStateUpdate', '9': 0, '10': 'streamStateUpdate'},
    const {'1': 'subscribed_quality_update', '3': 14, '4': 1, '5': 11, '6': '.livekit.SubscribedQualityUpdate', '9': 0, '10': 'subscribedQualityUpdate'},
    const {'1': 'subscription_permission_update', '3': 15, '4': 1, '5': 11, '6': '.livekit.SubscriptionPermissionUpdate', '9': 0, '10': 'subscriptionPermissionUpdate'},
    const {'1': 'refresh_token', '3': 16, '4': 1, '5': 9, '9': 0, '10': 'refreshToken'},
    const {'1': 'track_unpublished', '3': 17, '4': 1, '5': 11, '6': '.livekit.TrackUnpublishedResponse', '9': 0, '10': 'trackUnpublished'},
    const {'1': 'pong', '3': 18, '4': 1, '5': 3, '9': 0, '10': 'pong'},
    const {'1': 'reconnect', '3': 19, '4': 1, '5': 11, '6': '.livekit.ReconnectResponse', '9': 0, '10': 'reconnect'},
    const {'1': 'pong_resp', '3': 20, '4': 1, '5': 11, '6': '.livekit.Pong', '9': 0, '10': 'pongResp'},
  ],
  '8': const [
    const {'1': 'message'},
  ],
...
final $typed_data.Uint8List signalResponseDescriptor = $convert.base64Decode('');
...
const SimulcastCodec$json = const {
  ...
  '2': const [
    ...
    const {'1': 'enable_simulcast_layers', '3': 3, '4': 1, '5': 8, '10': 'enableSimulcastLayers'},
  ],
};

/// Descriptor for `SimulcastCodec`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List simulcastCodecDescriptor = $convert.base64Decode('Cg5TaW11bGNhc3RDb2RlYxIUCgVjb2RlYxgBIAEoCVIFY29kZWMSEAoDY2lkGAIgASgJUgNjaWQSNgoXZW5hYmxlX3NpbXVsY2FzdF9sYXllcnMYAyABKAhSFWVuYWJsZVNpbXVsY2FzdExheWVycw==');
...
const AddTrackRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'source', '3': 8, '4': 1, '5': 14, '6': '.livekit.TrackSource', '10': 'source'},
    const {'1': 'layers', '3': 9, '4': 3, '5': 11, '6': '.livekit.VideoLayer', '10': 'layers'},
    const {'1': 'simulcast_codecs', '3': 10, '4': 3, '5': 11, '6': '.livekit.SimulcastCodec', '10': 'simulcastCodecs'},
    const {'1': 'sid', '3': 11, '4': 1, '5': 9, '10': 'sid'},
    const {'1': 'stereo', '3': 12, '4': 1, '5': 8, '10': 'stereo'},
    const {'1': 'disable_red', '3': 13, '4': 1, '5': 8, '10': 'disableRed'},
    const {'1': 'encryption', '3': 14, '4': 1, '5': 14, '6': '.livekit.Encryption.Type', '10': 'encryption'},
  ],
};

/// Descriptor for `AddTrackRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List addTrackRequestDescriptor = $convert.base64Decode('');
...
const JoinResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'alternative_url', '3': 7, '4': 1, '5': 9, '10': 'alternativeUrl'},
    const {'1': 'client_configuration', '3': 8, '4': 1, '5': 11, '6': '.livekit.ClientConfiguration', '10': 'clientConfiguration'},
    const {'1': 'server_region', '3': 9, '4': 1, '5': 9, '10': 'serverRegion'},
    const {'1': 'ping_timeout', '3': 10, '4': 1, '5': 5, '10': 'pingTimeout'},
    const {'1': 'ping_interval', '3': 11, '4': 1, '5': 5, '10': 'pingInterval'},
    const {'1': 'server_info', '3': 12, '4': 1, '5': 11, '6': '.livekit.ServerInfo', '10': 'serverInfo'},
  ],
};
...
const ReconnectResponse$json = const {
  '1': 'ReconnectResponse',
  '2': const [
    const {'1': 'ice_servers', '3': 1, '4': 3, '5': 11, '6': '.livekit.ICEServer', '10': 'iceServers'},
    const {'1': 'client_configuration', '3': 2, '4': 1, '5': 11, '6': '.livekit.ClientConfiguration', '10': 'clientConfiguration'},
  ],
};

/// Descriptor for `ReconnectResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List reconnectResponseDescriptor = $convert.base64Decode('ChFSZWNvbm5lY3RSZXNwb25zZRIzCgtpY2Vfc2VydmVycxgBIAMoCzISLmxpdmVraXQuSUNFU2VydmVyUgppY2VTZXJ2ZXJzEk8KFGNsaWVudF9jb25maWd1cmF0aW9uGAIgASgLMhwubGl2ZWtpdC5DbGllbnRDb25maWd1cmF0aW9uUhNjbGllbnRDb25maWd1cmF0aW9u');
...
final $typed_data.Uint8List trackUnpublishedResponseDescriptor = $convert.base64Decode('ChhUcmFja1VucHVibGlzaGVkUmVzcG9uc2USGwoJdHJhY2tfc2lkGAEgASgJUgh0cmFja1NpZA==');
...
const UpdateSubscription$json = const {
  ...
  '2': const [
    ...
    const {'1': 'participant_tracks', '3': 3, '4': 3, '5': 11, '6': '.livekit.ParticipantTracks', '10': 'participantTracks'},
  ],
};

/// Descriptor for `UpdateSubscription`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateSubscriptionDescriptor = $convert.base64Decode('ChJVcGRhdGVTdWJzY3JpcHRpb24SHQoKdHJhY2tfc2lkcxgBIAMoCVIJdHJhY2tTaWRzEhwKCXN1YnNjcmliZRgCIAEoCFIJc3Vic2NyaWJlEkkKEnBhcnRpY2lwYW50X3RyYWNrcxgDIAMoCzIaLmxpdmVraXQuUGFydGljaXBhbnRUcmFja3NSEXBhcnRpY2lwYW50VHJhY2tz');
...
const LeaveRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'reason', '3': 2, '4': 1, '5': 14, '6': '.livekit.DisconnectReason', '10': 'reason'},
  ],
};

/// Descriptor for `LeaveRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List leaveRequestDescriptor = $convert.base64Decode('CgxMZWF2ZVJlcXVlc3QSIwoNY2FuX3JlY29ubmVjdBgBIAEoCFIMY2FuUmVjb25uZWN0EjEKBnJlYXNvbhgCIAEoDjIZLmxpdmVraXQuRGlzY29ubmVjdFJlYXNvblIGcmVhc29u');
@$core.Deprecated('Use updateVideoLayersDescriptor instead')
const UpdateVideoLayers$json = const {
  '1': 'UpdateVideoLayers',
  '2': const [
    const {'1': 'track_sid', '3': 1, '4': 1, '5': 9, '10': 'trackSid'},
    const {'1': 'layers', '3': 2, '4': 3, '5': 11, '6': '.livekit.VideoLayer', '10': 'layers'},
  ],
};

/// Descriptor for `UpdateVideoLayers`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateVideoLayersDescriptor = $convert.base64Decode('ChFVcGRhdGVWaWRlb0xheWVycxIbCgl0cmFja19zaWQYASABKAlSCHRyYWNrU2lkEisKBmxheWVycxgCIAMoCzITLmxpdmVraXQuVmlkZW9MYXllclIGbGF5ZXJz');
...
final $typed_data.Uint8List updateParticipantMetadataDescriptor = $convert.base64Decode('ChlVcGRhdGVQYXJ0aWNpcGFudE1ldGFkYXRhEhoKCG1ldGFkYXRhGAEgASgJUghtZXRhZGF0YQ==');
...
final $typed_data.Uint8List roomUpdateDescriptor = $convert.base64Decode('CgpSb29tVXBkYXRlEiEKBHJvb20YASABKAsyDS5saXZla2l0LlJvb21SBHJvb20=');
...
const ConnectionQualityInfo$json = const {
  ...
  '2': const [
    ...
    const {'1': 'quality', '3': 2, '4': 1, '5': 14, '6': '.livekit.ConnectionQuality', '10': 'quality'},
    const {'1': 'score', '3': 3, '4': 1, '5': 2, '10': 'score'},
  ],
};

/// Descriptor for `ConnectionQualityInfo`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List connectionQualityInfoDescriptor = $convert.base64Decode('ChVDb25uZWN0aW9uUXVhbGl0eUluZm8SJwoPcGFydGljaXBhbnRfc2lkGAEgASgJUg5wYXJ0aWNpcGFudFNpZBI0CgdxdWFsaXR5GAIgASgOMhoubGl2ZWtpdC5Db25uZWN0aW9uUXVhbGl0eVIHcXVhbGl0eRIUCgVzY29yZRgDIAEoAlIFc2NvcmU=');
...
const ConnectionQualityUpdate$json = const {
  ...
  '2': const [
    const {'1': 'updates', '3': 1, '4': 3, '5': 11, '6': '.livekit.ConnectionQualityInfo', '10': 'updates'},
  ],
};

/// Descriptor for `ConnectionQualityUpdate`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List connectionQualityUpdateDescriptor = $convert.base64Decode('ChdDb25uZWN0aW9uUXVhbGl0eVVwZGF0ZRI4Cgd1cGRhdGVzGAEgAygLMh4ubGl2ZWtpdC5Db25uZWN0aW9uUXVhbGl0eUluZm9SB3VwZGF0ZXM=');
...
const StreamStateInfo$json = const {
  ...
  '2': const [
    ...
    const {'1': 'state', '3': 3, '4': 1, '5': 14, '6': '.livekit.StreamState', '10': 'state'},
  ],
};

/// Descriptor for `StreamStateInfo`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List streamStateInfoDescriptor = $convert.base64Decode('Cg9TdHJlYW1TdGF0ZUluZm8SJwoPcGFydGljaXBhbnRfc2lkGAEgASgJUg5wYXJ0aWNpcGFudFNpZBIbCgl0cmFja19zaWQYAiABKAlSCHRyYWNrU2lkEioKBXN0YXRlGAMgASgOMhQubGl2ZWtpdC5TdHJlYW1TdGF0ZVIFc3RhdGU=');
@$core.Deprecated('Use streamStateUpdateDescriptor instead')
const StreamStateUpdate$json = const {
  '1': 'StreamStateUpdate',
  '2': const [
    const {'1': 'stream_states', '3': 1, '4': 3, '5': 11, '6': '.livekit.StreamStateInfo', '10': 'streamStates'},
  ],
};

/// Descriptor for `StreamStateUpdate`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List streamStateUpdateDescriptor = $convert.base64Decode('ChFTdHJlYW1TdGF0ZVVwZGF0ZRI9Cg1zdHJlYW1fc3RhdGVzGAEgAygLMhgubGl2ZWtpdC5TdHJlYW1TdGF0ZUluZm9SDHN0cmVhbVN0YXRlcw==');
@$core.Deprecated('Use subscribedQualityDescriptor instead')
const SubscribedQuality$json = const {
  '1': 'SubscribedQuality',
  '2': const [
    const {'1': 'quality', '3': 1, '4': 1, '5': 14, '6': '.livekit.VideoQuality', '10': 'quality'},
    const {'1': 'enabled', '3': 2, '4': 1, '5': 8, '10': 'enabled'},
  ],
};

/// Descriptor for `SubscribedQuality`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List subscribedQualityDescriptor = $convert.base64Decode('ChFTdWJzY3JpYmVkUXVhbGl0eRIvCgdxdWFsaXR5GAEgASgOMhUubGl2ZWtpdC5WaWRlb1F1YWxpdHlSB3F1YWxpdHkSGAoHZW5hYmxlZBgCIAEoCFIHZW5hYmxlZA==');
@$core.Deprecated('Use subscribedCodecDescriptor instead')
const SubscribedCodec$json = const {
  '1': 'SubscribedCodec',
  '2': const [
    const {'1': 'codec', '3': 1, '4': 1, '5': 9, '10': 'codec'},
    const {'1': 'qualities', '3': 2, '4': 3, '5': 11, '6': '.livekit.SubscribedQuality', '10': 'qualities'},
  ],
};

/// Descriptor for `SubscribedCodec`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List subscribedCodecDescriptor = $convert.base64Decode('Cg9TdWJzY3JpYmVkQ29kZWMSFAoFY29kZWMYASABKAlSBWNvZGVjEjgKCXF1YWxpdGllcxgCIAMoCzIaLmxpdmVraXQuU3Vic2NyaWJlZFF1YWxpdHlSCXF1YWxpdGllcw==');
...
const SubscribedQualityUpdate$json = const {
  ...
  '2': const [
    const {'1': 'track_sid', '3': 1, '4': 1, '5': 9, '10': 'trackSid'},
    const {'1': 'subscribed_qualities', '3': 2, '4': 3, '5': 11, '6': '.livekit.SubscribedQuality', '10': 'subscribedQualities'},
    const {'1': 'subscribed_codecs', '3': 3, '4': 3, '5': 11, '6': '.livekit.SubscribedCodec', '10': 'subscribedCodecs'},
  ],
};

/// Descriptor for `SubscribedQualityUpdate`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List subscribedQualityUpdateDescriptor = $convert.base64Decode('');
...
const TrackPermission$json = const {
  ...
  '2': const [
    ...
    const {'1': 'participant_identity', '3': 4, '4': 1, '5': 9, '10': 'participantIdentity'},
  ],
};

/// Descriptor for `TrackPermission`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List trackPermissionDescriptor = $convert.base64Decode('Cg9UcmFja1Blcm1pc3Npb24SJwoPcGFydGljaXBhbnRfc2lkGAEgASgJUg5wYXJ0aWNpcGFudFNpZBIdCgphbGxfdHJhY2tzGAIgASgIUglhbGxUcmFja3MSHQoKdHJhY2tfc2lkcxgDIAMoCVIJdHJhY2tTaWRzEjEKFHBhcnRpY2lwYW50X2lkZW50aXR5GAQgASgJUhNwYXJ0aWNpcGFudElkZW50aXR5');
...
const SubscriptionPermission$json = const {
  ...
  '2': const [
    const {'1': 'all_participants', '3': 1, '4': 1, '5': 8, '10': 'allParticipants'},
    const {'1': 'track_permissions', '3': 2, '4': 3, '5': 11, '6': '.livekit.TrackPermission', '10': 'trackPermissions'},
  ],
};

/// Descriptor for `SubscriptionPermission`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List subscriptionPermissionDescriptor = $convert.base64Decode('ChZTdWJzY3JpcHRpb25QZXJtaXNzaW9uEikKEGFsbF9wYXJ0aWNpcGFudHMYASABKAhSD2FsbFBhcnRpY2lwYW50cxJFChF0cmFja19wZXJtaXNzaW9ucxgCIAMoCzIYLmxpdmVraXQuVHJhY2tQZXJtaXNzaW9uUhB0cmFja1Blcm1pc3Npb25z');
...
final $typed_data.Uint8List subscriptionPermissionUpdateDescriptor = $convert.base64Decode('ChxTdWJzY3JpcHRpb25QZXJtaXNzaW9uVXBkYXRlEicKD3BhcnRpY2lwYW50X3NpZBgBIAEoCVIOcGFydGljaXBhbnRTaWQSGwoJdHJhY2tfc2lkGAIgASgJUgh0cmFja1NpZBIYCgdhbGxvd2VkGAMgASgIUgdhbGxvd2Vk');
@$core.Deprecated('Use syncStateDescriptor instead')
const SyncState$json = const {
  '1': 'SyncState',
  '2': const [
    const {'1': 'answer', '3': 1, '4': 1, '5': 11, '6': '.livekit.SessionDescription', '10': 'answer'},
    const {'1': 'subscription', '3': 2, '4': 1, '5': 11, '6': '.livekit.UpdateSubscription', '10': 'subscription'},
    const {'1': 'publish_tracks', '3': 3, '4': 3, '5': 11, '6': '.livekit.TrackPublishedResponse', '10': 'publishTracks'},
    const {'1': 'data_channels', '3': 4, '4': 3, '5': 11, '6': '.livekit.DataChannelInfo', '10': 'dataChannels'},
    const {'1': 'offer', '3': 5, '4': 1, '5': 11, '6': '.livekit.SessionDescription', '10': 'offer'},
  ],
};

/// Descriptor for `SyncState`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List syncStateDescriptor = $convert.base64Decode('');
...
const DataChannelInfo$json = const {
  ...
  '2': const [
    ...
    const {'1': 'target', '3': 3, '4': 1, '5': 14, '6': '.livekit.SignalTarget', '10': 'target'},
  ],
};

/// Descriptor for `DataChannelInfo`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List dataChannelInfoDescriptor = $convert.base64Decode('Cg9EYXRhQ2hhbm5lbEluZm8SFAoFbGFiZWwYASABKAlSBWxhYmVsEg4KAmlkGAIgASgNUgJpZBItCgZ0YXJnZXQYAyABKA4yFS5saXZla2l0LlNpZ25hbFRhcmdldFIGdGFyZ2V0');
@$core.Deprecated('Use simulateScenarioDescriptor instead')
const SimulateScenario$json = const {
  '1': 'SimulateScenario',
  '2': const [
    const {'1': 'speaker_update', '3': 1, '4': 1, '5': 5, '9': 0, '10': 'speakerUpdate'},
    const {'1': 'node_failure', '3': 2, '4': 1, '5': 8, '9': 0, '10': 'nodeFailure'},
    const {'1': 'migration', '3': 3, '4': 1, '5': 8, '9': 0, '10': 'migration'},
    const {'1': 'server_leave', '3': 4, '4': 1, '5': 8, '9': 0, '10': 'serverLeave'},
    const {'1': 'switch_candidate_protocol', '3': 5, '4': 1, '5': 14, '6': '.livekit.CandidateProtocol', '9': 0, '10': 'switchCandidateProtocol'},
  ],
  '8': const [
    const {'1': 'scenario'},
  ],
...
final $typed_data.Uint8List pingDescriptor = $convert.base64Decode('CgRQaW5nEhwKCXRpbWVzdGFtcBgBIAEoA1IJdGltZXN0YW1wEhAKA3J0dBgCIAEoA1IDcnR0');
@$core.Deprecated('Use pongDescriptor instead')
const Pong$json = const {
  '1': 'Pong',
  '2': const [
    const {'1': 'last_ping_timestamp', '3': 1, '4': 1, '5': 3, '10': 'lastPingTimestamp'},
    const {'1': 'timestamp', '3': 2, '4': 1, '5': 3, '10': 'timestamp'},
  ],
};

/// Descriptor for `Pong`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List pongDescriptor = $convert.base64Decode('CgRQb25nEi4KE2xhc3RfcGluZ190aW1lc3RhbXAYASABKANSEWxhc3RQaW5nVGltZXN0YW1wEhwKCXRpbWVzdGFtcBgCIAEoA1IJdGltZXN0YW1w');
