...
final $typed_data.Uint8List trackSourceDescriptor = $convert.base64Decode('CgtUcmFja1NvdXJjZRILCgdVTktOT1dOEAASCgoGQ0FNRVJBEAESDgoKTUlDUk9QSE9ORRACEhAKDFNDUkVFTl9TSEFSRRADEhYKElNDUkVFTl9TSEFSRV9BVURJTxAE');
...
final $typed_data.Uint8List videoQualityDescriptor = $convert.base64Decode('CgxWaWRlb1F1YWxpdHkSBwoDTE9XEAASCgoGTUVESVVNEAESCAoESElHSBACEgcKA09GRhAD');
...
final $typed_data.Uint8List connectionQualityDescriptor = $convert.base64Decode('ChFDb25uZWN0aW9uUXVhbGl0eRIICgRQT09SEAASCAoER09PRBABEg0KCUVYQ0VMTEVOVBAC');
...
final $typed_data.Uint8List clientConfigSettingDescriptor = $convert.base64Decode('ChNDbGllbnRDb25maWdTZXR0aW5nEgkKBVVOU0VUEAASDAoIRElTQUJMRUQQARILCgdFTkFCTEVEEAI=');
...
final $typed_data.Uint8List disconnectReasonDescriptor = $convert.base64Decode('ChBEaXNjb25uZWN0UmVhc29uEhIKDlVOS05PV05fUkVBU09OEAASFAoQQ0xJRU5UX0lOSVRJQVRFRBABEhYKEkRVUExJQ0FURV9JREVOVElUWRACEhMKD1NFUlZFUl9TSFVURE9XThADEhcKE1BBUlRJQ0lQQU5UX1JFTU9WRUQQBBIQCgxST09NX0RFTEVURUQQBRISCg5TVEFURV9NSVNNQVRDSBAGEhAKDEpPSU5fRkFJTFVSRRAH');
...
final $typed_data.Uint8List reconnectReasonDescriptor = $convert.base64Decode('Cg9SZWNvbm5lY3RSZWFzb24SDQoJUlJfVU5LT1dOEAASGgoWUlJfU0lHTkFMX0RJU0NPTk5FQ1RFRBABEhcKE1JSX1BVQkxJU0hFUl9GQUlMRUQQAhIYChRSUl9TVUJTQ1JJQkVSX0ZBSUxFRBADEhcKE1JSX1NXSVRDSF9DQU5ESURBVEUQBA==');
...
const Room$json = const {
  ...
  '2': const [
    ...
    const {'1': 'num_participants', '3': 9, '4': 1, '5': 13, '10': 'numParticipants'},
    const {'1': 'active_recording', '3': 10, '4': 1, '5': 8, '10': 'activeRecording'},
  ],
};

/// Descriptor for `Room`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List roomDescriptor = $convert.base64Decode('');
...
const ParticipantPermission$json = const {
  ...
  '2': const [
    ...
    const {'1': 'can_publish_data', '3': 3, '4': 1, '5': 8, '10': 'canPublishData'},
    const {'1': 'can_publish_sources', '3': 9, '4': 3, '5': 14, '6': '.livekit.TrackSource', '10': 'canPublishSources'},
...
final $typed_data.Uint8List participantPermissionDescriptor = $convert.base64Decode('');
...
const ParticipantInfo$json = const {
  ...
  '2': const [
    ...
    const {'1': 'permission', '3': 11, '4': 1, '5': 11, '6': '.livekit.ParticipantPermission', '10': 'permission'},
...
final $typed_data.Uint8List participantInfoDescriptor = $convert.base64Decode('');
...
const SimulcastCodecInfo$json = const {
  ...
  '2': const [
    ...
    const {'1': 'layers', '3': 4, '4': 3, '5': 11, '6': '.livekit.VideoLayer', '10': 'layers'},
  ],
};

/// Descriptor for `SimulcastCodecInfo`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List simulcastCodecInfoDescriptor = $convert.base64Decode('ChJTaW11bGNhc3RDb2RlY0luZm8SGwoJbWltZV90eXBlGAEgASgJUghtaW1lVHlwZRIQCgNtaWQYAiABKAlSA21pZBIQCgNjaWQYAyABKAlSA2NpZBIrCgZsYXllcnMYBCADKAsyEy5saXZla2l0LlZpZGVvTGF5ZXJSBmxheWVycw==');
...
const TrackInfo$json = const {
  ...
  '2': const [
    ...
    const {'1': 'source', '3': 9, '4': 1, '5': 14, '6': '.livekit.TrackSource', '10': 'source'},
    const {'1': 'layers', '3': 10, '4': 3, '5': 11, '6': '.livekit.VideoLayer', '10': 'layers'},
    const {'1': 'mime_type', '3': 11, '4': 1, '5': 9, '10': 'mimeType'},
    const {'1': 'mid', '3': 12, '4': 1, '5': 9, '10': 'mid'},
    const {'1': 'codecs', '3': 13, '4': 3, '5': 11, '6': '.livekit.SimulcastCodecInfo', '10': 'codecs'},
    const {'1': 'stereo', '3': 14, '4': 1, '5': 8, '10': 'stereo'},
    const {'1': 'disable_red', '3': 15, '4': 1, '5': 8, '10': 'disableRed'},
    const {'1': 'encryption', '3': 16, '4': 1, '5': 14, '6': '.livekit.Encryption.Type', '10': 'encryption'},
  ],
};

/// Descriptor for `TrackInfo`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List trackInfoDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List videoLayerDescriptor = $convert.base64Decode('CgpWaWRlb0xheWVyEi8KB3F1YWxpdHkYASABKA4yFS5saXZla2l0LlZpZGVvUXVhbGl0eVIHcXVhbGl0eRIUCgV3aWR0aBgCIAEoDVIFd2lkdGgSFgoGaGVpZ2h0GAMgASgNUgZoZWlnaHQSGAoHYml0cmF0ZRgEIAEoDVIHYml0cmF0ZRISCgRzc3JjGAUgASgNUgRzc3Jj');
...
final $typed_data.Uint8List participantTracksDescriptor = $convert.base64Decode('ChFQYXJ0aWNpcGFudFRyYWNrcxInCg9wYXJ0aWNpcGFudF9zaWQYASABKAlSDnBhcnRpY2lwYW50U2lkEh0KCnRyYWNrX3NpZHMYAiADKAlSCXRyYWNrU2lkcw==');
@$core.Deprecated('Use serverInfoDescriptor instead')
const ServerInfo$json = const {
  '1': 'ServerInfo',
  '2': const [
    const {'1': 'edition', '3': 1, '4': 1, '5': 14, '6': '.livekit.ServerInfo.Edition', '10': 'edition'},
...
final $typed_data.Uint8List serverInfoDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use clientInfoDescriptor instead')
const ClientInfo$json = const {
  '1': 'ClientInfo',
  '2': const [
    const {'1': 'sdk', '3': 1, '4': 1, '5': 14, '6': '.livekit.ClientInfo.SDK', '10': 'sdk'},
    const {'1': 'version', '3': 2, '4': 1, '5': 9, '10': 'version'},
    const {'1': 'protocol', '3': 3, '4': 1, '5': 5, '10': 'protocol'},
    ...
    const {'1': 'browser_version', '3': 8, '4': 1, '5': 9, '10': 'browserVersion'},
...
const ClientConfiguration$json = const {
  ...
  '2': const [
    const {'1': 'video', '3': 1, '4': 1, '5': 11, '6': '.livekit.VideoConfiguration', '10': 'video'},
    const {'1': 'screen', '3': 2, '4': 1, '5': 11, '6': '.livekit.VideoConfiguration', '10': 'screen'},
    const {'1': 'resume_connection', '3': 3, '4': 1, '5': 14, '6': '.livekit.ClientConfigSetting', '10': 'resumeConnection'},
    const {'1': 'disabled_codecs', '3': 4, '4': 1, '5': 11, '6': '.livekit.DisabledCodecs', '10': 'disabledCodecs'},
    const {'1': 'force_relay', '3': 5, '4': 1, '5': 14, '6': '.livekit.ClientConfigSetting', '10': 'forceRelay'},
  ],
};

/// Descriptor for `ClientConfiguration`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List clientConfigurationDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use videoConfigurationDescriptor instead')
const VideoConfiguration$json = const {
  '1': 'VideoConfiguration',
  '2': const [
    const {'1': 'hardware_encoder', '3': 1, '4': 1, '5': 14, '6': '.livekit.ClientConfigSetting', '10': 'hardwareEncoder'},
  ],
};

/// Descriptor for `VideoConfiguration`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List videoConfigurationDescriptor = $convert.base64Decode('ChJWaWRlb0NvbmZpZ3VyYXRpb24SRwoQaGFyZHdhcmVfZW5jb2RlchgBIAEoDjIcLmxpdmVraXQuQ2xpZW50Q29uZmlnU2V0dGluZ1IPaGFyZHdhcmVFbmNvZGVy');
@$core.Deprecated('Use disabledCodecsDescriptor instead')
const DisabledCodecs$json = const {
  '1': 'DisabledCodecs',
  '2': const [
    const {'1': 'codecs', '3': 1, '4': 3, '5': 11, '6': '.livekit.Codec', '10': 'codecs'},
  ],
};

/// Descriptor for `DisabledCodecs`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List disabledCodecsDescriptor = $convert.base64Decode('Cg5EaXNhYmxlZENvZGVjcxImCgZjb2RlY3MYASADKAsyDi5saXZla2l0LkNvZGVjUgZjb2RlY3M=');
...
const RTPStats$json = const {
  ...
  '2': const [
    ...
    const {'1': 'packet_loss_rate', '3': 9, '4': 1, '5': 1, '10': 'packetLossRate'},
    ...
    const {'1': 'packet_duplicate_rate', '3': 12, '4': 1, '5': 1, '10': 'packetDuplicateRate'},
    const {'1': 'bytes_duplicate', '3': 13, '4': 1, '5': 4, '10': 'bytesDuplicate'},
    const {'1': 'header_bytes_duplicate', '3': 40, '4': 1, '5': 4, '10': 'headerBytesDuplicate'},
    const {'1': 'bitrate_duplicate', '3': 14, '4': 1, '5': 1, '10': 'bitrateDuplicate'},
    const {'1': 'packets_padding', '3': 15, '4': 1, '5': 13, '10': 'packetsPadding'},
    const {'1': 'packet_padding_rate', '3': 16, '4': 1, '5': 1, '10': 'packetPaddingRate'},
    const {'1': 'bytes_padding', '3': 17, '4': 1, '5': 4, '10': 'bytesPadding'},
    const {'1': 'header_bytes_padding', '3': 41, '4': 1, '5': 4, '10': 'headerBytesPadding'},
    const {'1': 'bitrate_padding', '3': 18, '4': 1, '5': 1, '10': 'bitratePadding'},
    const {'1': 'packets_out_of_order', '3': 19, '4': 1, '5': 13, '10': 'packetsOutOfOrder'},
    const {'1': 'frames', '3': 20, '4': 1, '5': 13, '10': 'frames'},
    const {'1': 'frame_rate', '3': 21, '4': 1, '5': 1, '10': 'frameRate'},
    const {'1': 'jitter_current', '3': 22, '4': 1, '5': 1, '10': 'jitterCurrent'},
    const {'1': 'jitter_max', '3': 23, '4': 1, '5': 1, '10': 'jitterMax'},
    const {'1': 'gap_histogram', '3': 24, '4': 3, '5': 11, '6': '.livekit.RTPStats.GapHistogramEntry', '10': 'gapHistogram'},
    ...
    const {'1': 'nack_repeated', '3': 38, '4': 1, '5': 13, '10': 'nackRepeated'},
    const {'1': 'plis', '3': 27, '4': 1, '5': 13, '10': 'plis'},
    const {'1': 'last_pli', '3': 28, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'lastPli'},
    const {'1': 'firs', '3': 29, '4': 1, '5': 13, '10': 'firs'},
    const {'1': 'last_fir', '3': 30, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'lastFir'},
    ...
    const {'1': 'last_key_frame', '3': 34, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'lastKeyFrame'},
    const {'1': 'layer_lock_plis', '3': 35, '4': 1, '5': 13, '10': 'layerLockPlis'},
    const {'1': 'last_layer_lock_pli', '3': 36, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'lastLayerLockPli'},
  ],
...
final $typed_data.Uint8List rTPStatsDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List timedVersionDescriptor = $convert.base64Decode('CgxUaW1lZFZlcnNpb24SHQoKdW5peF9taWNybxgBIAEoA1IJdW5peE1pY3JvEhQKBXRpY2tzGAIgASgFUgV0aWNrcw==');
