...
AgentAttributes _$AgentAttributesFromJson(Map<String, dynamic> json) => AgentAttributes(
  lkAgentInputs: (json['lk.agent.inputs'] as List<dynamic>?)?.map((e) => $enumDecode(_$AgentInputEnumMap, e)).toList(),
...
Map<String, dynamic> _$AgentAttributesToJson(AgentAttributes instance) => <String, dynamic>{
  if (instance.lkAgentInputs?.map((e) => _$AgentInputEnumMap[e]!).toList() case final value?) 'lk.agent.inputs': value,
