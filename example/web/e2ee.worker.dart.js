...
(function dartProgram() {
  ...
  A.Cryptor.prototype = {
    ...
    getUnencryptedBytes$2(frame, codec) {
      var data, naluIndices, t1, t2, _i, index, type;
      if (codec != null && codec.toLowerCase() === "h264") {
        ...
        for (t1 = naluIndices.length, t2 = data.length, _i = 0; _i < naluIndices.length; naluIndices.length === t1 || (0, A.throwConcurrentModificationError)(naluIndices), ++_i) {
          ...
          switch (type) {
            ...
            case 1:
              t1 = index + 2;
              A.printString("unEncryptedBytes NALU of type " + type + ", offset " + t1);
              return t1;
            default:
              A.printString("skipping NALU of type " + type);
              break;
          }
        }
    ...
    decodeFunction$body$Cryptor(frame, controller) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, $async$handler = 2, $async$currentError, $async$self = this, headerLength, frameTrailer, ivLength, iv, decrypted, finalBuffer, e, t2, t3, t4, t5, t6, exception, t1, buffer, $async$exception;
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Closure, [A.Closure2Args, A.Closure0Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._awaitOnObject_closure, A._Future__chainForeignFuture_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A._EventStreamSubscription_closure, A._convertDataTree__convert, A.promiseToFuture_closure, A.promiseToFuture_closure0, A.main_closure, A.main__closure6, A.main_closure0, A.main__closure, A.main__closure0, A.main__closure1, A.main__closure2, A.main__closure3, A.main__closure4, A.main__closure5]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "bool(Cryptor)", "~(String,@)", "Null(@)", "~(@)", "~(~())", "Null()", "Future<~>(RTCEncodedFrame,TransformStreamDefaultController)", "@(@)", "@(@,String)", "@(String)", "Null(~())", "Null(@,StackTrace)", "~(int,@)", "Null(Object,StackTrace)", "_Future<@>(@)", "~(Object?,Object?)", "~(Symbol0,@)", "~(String,String)", "~(Event)", "~(@,@)", "Null(@,@)", "@(@,@)", "Object?(Object?)", "~(MessageEvent)"],
