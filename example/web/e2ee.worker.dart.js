...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    cryptoKeyFromAesSecretKey(secretKeyData, webCryptoAlgorithm) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.CryptoKey),
        $async$returnValue;
      var $async$cryptoKeyFromAesSecretKey = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$returnValue = A.promiseToFuture(self.crypto.subtle.importKey("raw", A.jsArrayBufferFrom(secretKeyData), webCryptoAlgorithm, false, A._setArrayType(["encrypt", "decrypt"], type$.JSArray_String)), type$.CryptoKey);
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$cryptoKeyFromAesSecretKey, $async$completer);
    },
  ...
  A.Cryptor.prototype = {
    ...
    setKey$1(key) {
      ...
      return A._asyncStartSync($async$setKey$1, $async$completer);
    },
    ...
    encodeFunction$body$Cryptor(frame, controller) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, $async$handler = 2, $async$currentError, $async$self = this, headerLength, metaData, iv, frameTrailer, cipherText, finalBuffer, e, t2, t3, t4, iv0, sendCount, exception, t1, buffer, $async$exception;
    ...
    decodeFunction$body$Cryptor(frame, controller) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, $async$handler = 2, $async$currentError, $async$self = this, headerLength, metaData, frameTrailer, ivLength, keyIndex, iv, decrypted, finalBuffer, e, t2, t3, t4, t5, t6, exception, t1, buffer, $async$exception;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$goto = 7;
              return A._asyncAwait(A.promiseToFuture(self.crypto.subtle.decrypt(t4, t3, A.jsArrayBufferFrom(J.sublist$2$x(buffer, headerLength, t5 - t6 - 2))), type$.ByteBuffer), $async$decodeFunction$2);
            case 7:
              // returning from await.
  ...
  A.main_closure0.prototype = {
    call$1(e) {
      ...
      switch (msgType) {
        case "init":
          $.useSharedKey = A._asBool(t1.$index(copy, "useSharedKey"));
          break;
        case "enable":
        ...
        case "encode":
          ...
          cryptor = B.JSArray_methods.firstWhere$2$orElse($.participantCryptors, new A.main__closure0(trackId), new A.main__closure1(participantId, trackId));
          A._asString(msgType);
          A._asString(trackId);
        ...
        case "removeTransform":
          ...
          t1 = $.participantCryptors;
          t2 = A._arrayInstanceType(t1)._eval$1("bool(1)")._as(new A.main__closure2(trackId));
          if (!!t1.fixed$length)
        ...
        case "setKey":
          ...
          A.print("worker: got setKey " + A.S(t1.$index(copy, "key")) + ", key " + A.S(key));
          participantId = A._asString(t1.$index(copy, _s13_));
          ...
          t1 = key.length;
          if (t1 !== 32) {
            A.print("worker: invalid key length " + t1);
            break;
          }
          for (t1 = cryptors.length, _i = 0; _i < t1; ++_i)
            cryptors[_i].setKey$1(key);
          break;
        case "setKeyIndex":
          ...
          t2 = A._arrayInstanceType(t1);
          t3 = t2._eval$1("WhereIterable<1>");
          cryptors = A.List_List$of(new A.WhereIterable(t1, t2._eval$1("bool(1)")._as(new A.main__closure4(participantId)), t3), true, t3._eval$1("Iterable.E"));
          for (t1 = cryptors.length, _i = 0; _i < t1; ++_i)
  ...
  A.main__closure1.prototype = {
    call$0() {
      var t1 = A._asString(this.trackId);
      return A.Cryptor$(this.participantId, $.useSharedKey, t1);
    },
    $signature: 25
  };
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Closure, [A.Closure2Args, A.Closure0Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._awaitOnObject_closure, A._Future__chainForeignFuture_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A._EventStreamSubscription_closure, A._convertDataTree__convert, A.promiseToFuture_closure, A.promiseToFuture_closure0, A.main_closure, A.main_closure0, A.main__closure, A.main__closure0, A.main__closure2, A.main__closure3, A.main__closure4, A.main__closure5]);
