// Generated by dart2js (NullSafetyMode.sound, csp, deferred-serialization, intern-composite-values), the Dart to JavaScript compiler version: 2.19.1.
...
(function dartProgram() {
  ...
  A.main_closure.prototype = {
    call$1($event) {
      var t1, options, t2, kind, participantId, trackId, codec, msgType, cryptor, t3;
      ...
      t3 = trackId == null ? A._asString(trackId) : trackId;
      A._asString(kind);
      cryptor.setupTransform$6$codec$kind$operation$readable$trackId$writable(A._asStringQ(codec), kind, msgType, t2, t3, t1);
